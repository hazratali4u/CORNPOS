...
namespace CORNCommon.Classes
{
    ...
    public class Enums
    {
        ...
        public enum AppSetting
        {
            ...
            ScaleStopBit = 47,
            GSTCalculation = 48,
            IsAutoPasswordChangeAlert = 62,
            AutoPasswordChangeDays = 63,
            RiderUserCreation = 64,
            AWSAccessKeyID = 66,
            AWSSecretAccessKeyID = 67,
            AWSBucketName = 68
        }
        ...
        public enum COAMapping
        {
            ...
            DebitClaim               = 20,
            CreditClaim              = 21,
            DiscountonCreditCardSale = 22,
            OpeningStock = 23,
            CreditSaleReceivable = 29,
            WithHoldingTax = 31,
            ServiceCharges = 32,
            AdvanceForLocalPurchase = 33,
            BankDiscountPortion = 34,
            CashSkimming = 35,
            ComplimentaryDiscount = 36,
            AdvanceTax = 37
        }
    }
}