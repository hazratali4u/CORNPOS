...
namespace CORNCommon.Classes
{
	...
	public class clsWebFormUtil
	{
        ...
        public static void FillDxListBox(DevExpress.Web.ASPxCheckBoxList pLstControl, DataTable pObjTable, string pColKey, string pColValue)
        {
            clsWebFormUtil.FillDxListBox(pLstControl, pObjTable, pColKey, pColValue, false);
        }

        public static void FillDxListBox(DevExpress.Web.ASPxCheckBoxList pLstControl, DataTable pObjTable, string pColKey, string pColValue, bool pBClearListItems)
        {
            clsWebFormUtil.FillDxListBox(pLstControl, pObjTable, pColKey, pColValue, pBClearListItems, true);
        }

        public static void FillDxListBox(DevExpress.Web.ASPxCheckBoxList pLstControl, DataTable pObjTable, string pColKey, string pColValue, bool pBClearListItems, bool pBSortList)
        {
            /**			 
			 * Inserted For: Allowing the clearing of the list.
			 */
            if (pLstControl != null)
            {
                if (pObjTable != null)
                {
                    ...
                    {
                        // Add each element as clsListItem.
                        pLstControl.Items.Add(new DevExpress.Web.ListEditItem(pObjTable.Rows[nI][pColValue].ToString(), pObjTable.Rows[nI][pColKey].ToString()));
                    }
        ...
        public static void FillDxComboBoxList(DevExpress.Web.ASPxComboBox pCboControl, DataTable pObjTable, string pColKey, string pColValue)
        {
            clsWebFormUtil.FillDxComboBoxList(pCboControl, pObjTable, pColKey, pColValue, false);
        }


        public static void FillDxComboBoxList(DevExpress.Web.ASPxComboBox pCboControl, DataTable pObjTable, string pColKey, string pColValue, bool pBClearListItems)
        {
            if (pObjTable != null)
            {
                // Clear list items if asked.
                ...
                {
                    // Add each element as clsListItem.
                    pCboControl.Items.Add(new DevExpress.Web.ListEditItem(pObjTable.Rows[nI][pColValue].ToString(), pObjTable.Rows[nI][pColKey].ToString()));
                }
            }
            else
            {
        ...
        public static void FillDxComboBoxList(DevExpress.Web.ASPxComboBox pCboControl, DataTable pObjTable, int pColKey, int pColValue)
        {
            clsWebFormUtil.FillDxComboBoxList(pCboControl, pObjTable, pColKey, pColValue, false);
        }


        public static void FillDxComboBoxList(DevExpress.Web.ASPxComboBox pCboControl, DataTable pObjTable, int pColKey, int pColValue, bool pBClearListItems)
        {
            if (pObjTable != null)
            {
                // Clear list items if asked.
