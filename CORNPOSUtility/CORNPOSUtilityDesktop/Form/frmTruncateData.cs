...
{
    public partial class frmTruncateData : Form
    {
        public frmTruncateData(Main Parent)
        {
            InitializeComponent();
        }
        ...
        private void btnTruncate_Click(object sender, EventArgs e)
        {
            if (txtDBName.Text.Trim().Length > 0)
            {
                ...
                if (confirmResult == DialogResult.Yes)
                {
                    ...
                    AddConstraints();
                    ZKMessgeBox.Show("Transaction Truncated of " + txtDBName.Text.Trim() + " Database");
                    txtDBName.Text = string.Empty;
                }
            }
            else
            {
                ZKMessgeBox.Show("Enter Database Name.");
            }
        }
        ...
        private void InsertDayClose(List <string> lst)
        {
            ...
            foreach (string distributorid in lst)
            {
                ...
                scriptDayClose.Append(" INSERT INTO DAILY_CLOSE(CLOSING_DATE,DISTRIBUTOR_ID,OPENING_CASH,TIME_STAMP) VALUES('" + dtpDate.Value.ToString("yyyy-MM-dd") + "'," + distributorid + ",0,'" + System.DateTime.Now + "')");
        ...
        private void UpdateSKUPriceTable()
        {
            ...
            scriptDayCloseTable.Append(Environment.NewLine);
            scriptDayCloseTable.Append(" UPDATE SKU_PRICES SET DATE_EFFECTED = '" + dtpDate.Value.AddDays(1).ToString("yyyy-MM-dd")  + "'");
            ExecuteScript(scriptDayCloseTable.ToString());
        }        
            ...
            using (SqlConnection con = new SqlConnection(conString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(string.Format("USE {0} SELECT D.DISTRIBUTOR_ID,D.DISTRIBUTOR_NAME,(SELECT MAX(CLOSING_DATE) FROM DAILY_CLOSE WHERE DISTRIBUTOR_ID = D.DISTRIBUTOR_ID) AS WorkingDate FROM DISTRIBUTOR D WHERE D.ISDELETED = 0", cbDatabase.SelectedItem), con))
                {
                    using (IDataReader dr = cmd.ExecuteReader())
                    {
                        while (dr.Read())
                        {
                            locationListDictionary.Add(Convert.ToInt32(dr[0]), dr[1].ToString() + '-' + dr[2].ToString());
                        }
                    }
                }
                con.Close();
        ...
        private void btnTruncateSingleLocationData_Click(object sender, EventArgs e)
        {
            if (cblLocation.Items.Count> 0)
            {
                var confirmResult = ZKMessgeBox.Show("Did you took backup of " + cbDatabase.SelectedItem + " Database??", "Confirm Database Backup!!", ZKMessgeBox.I8Buttons.YesNo);
                if (confirmResult == DialogResult.Yes)
                {
                    TruncateSingleLocationDate(Convert.ToInt32(cblLocation.SelectedValue));
                    ZKMessgeBox.Show(cblLocation.Text + " Location Data Truncated");
                }
            }
        }
        ...
        private void TruncateSingleLocationDate(int DistributorID)
        {
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptCASH_SKIMMINGTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptCHEQUE_PROCESSTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptCHEQUE_PROCESS_DETAILTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptDAILY_CLOSETable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptGL_DETAILTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptGL_MASTERTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptLEDGERTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptVENDOR_LEDGERable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptSKU_STOCK_REGISTERTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptPURCHASE_MASTERTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptSALE_INVOICE_CONSUMEDTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptSALE_INVOICE_DETAILTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptSALE_INVOICE_MASTERTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptSHIFT_CLOSETable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptSHIFT_OPENING_AMOUNTTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptSTOCK_DEMAND_DETAILTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptSTOCK_DEMAND_MASTERTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scripttblSplitItemDetailTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scripttblSplitItemMasterTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scripttblTodayMenuTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scripttblProductionPlanDetailTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scripttblProductionPlanMasterTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scripttblBOMIssuanceDetailTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scripttblBOMIssuanceMasterTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scripttPurchase_Order_DetailTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptPurchase_Order_MasterTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptFRANCHISE_SALE_INVOICE_DETAILTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptFRANCHISE_SALE_INVOICE_MASTERTable.ToString());
            ...
            scriptDropFK_tblRecipeProductionDetail_FINISHED_GOOD_DETAIL.Append(Environment.NewLine);
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptDropFK_tblRecipeProductionDetail_FINISHED_GOOD_DETAIL.ToString());
            ...
            scriptDropFK_tblRecipeProductionDetail_tblRecipeProductionMaster.Append(Environment.NewLine);
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptDropFK_tblRecipeProductionDetail_tblRecipeProductionMaster.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scripttblRecipeProductionDetailTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scripttblRecipeProductionMasterTable.ToString());
            ...
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptKDS_HISTORYTable.ToString());
            ...
            scriptAddFK_tblRecipeProductionDetail_FINISHED_GOOD_DETAIL.Append(Environment.NewLine);
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptAddFK_tblRecipeProductionDetail_FINISHED_GOOD_DETAIL.ToString());
            ...
            scriptAddFK_tblRecipeProductionDetail_tblRecipeProductionMaster.Append(Environment.NewLine);
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptAddFK_tblRecipeProductionDetail_tblRecipeProductionMaster.ToString());

            StringBuilder scriptDayClose = new StringBuilder();
            scriptDayClose.Append(Environment.NewLine);
            scriptDayClose.Append(" INSERT INTO DAILY_CLOSE(CLOSING_DATE,DISTRIBUTOR_ID,OPENING_CASH,TIME_STAMP) VALUES('" + DateTime.Now.AddDays(-1).ToString("yyyy-MM-dd") + "'," + DistributorID + ",0,'" + System.DateTime.Now + "')");
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptDayClose.ToString());

            StringBuilder scriptDayCloseTable = new StringBuilder();

            scriptDayCloseTable.Append(Environment.NewLine);
            scriptDayCloseTable.Append(" UPDATE SKU_PRICES SET DATE_EFFECTED = '" + DateTime.Now.ToString("yyyy-MM-dd") + "' WHERE DISTRIBUTOR_ID=" + DistributorID);
            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptDayCloseTable.ToString());
        }
        private void DeletePurchaseDetail(int DistributorID)
        {
            ...
            {
                con.Open();
                using (SqlCommand cmd = new SqlCommand(string.Format("USE {0} SELECT PURCHASE_DETAIL_ID FROM PURCHASE_DETAIL WHERE DISTRIBUTOR_ID = " + DistributorID, cbDatabase.SelectedItem), con))
                {
                    using (IDataReader dr = cmd.ExecuteReader())
                    {
                        while (dr.Read())
                        {
                            ...
                            ExecuteScript(cbDatabase.SelectedItem.ToString(), scriptPURCHASE_DETAILTable.ToString());
                        }
                    }
                }
                con.Close();
