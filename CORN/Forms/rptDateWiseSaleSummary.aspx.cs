...
/// </summary>
public partial class Forms_rptDateWiseSaleSummary : Page
{
    ...
    private void ShowReport(int pReprotType)
    {
        ...
        DataSet ds = _rptSaleCtl.SalesReportDateWise(drpDistributor.SelectedItem.Value.ToString(),DateTime.Parse(txtStartDate.Text + " 00:00:00"), DateTime.Parse(txtEndDate.Text + " 23:59:59"),int.Parse(Session["UserId"].ToString()));

            var crpReport = new CrpDateWiseSaleSummary();
    ...
    protected void txtStartDate_TextChanged(object sender, EventArgs e)
    {
        ...
        CEEndDate.StartDate = fromDate;
        CEEndDate.EndDate = fromDate.AddDays(6);
        txtEndDate.Text = fromDate.AddDays(6).ToString("dd-MMM-yyyy");
    }
}
