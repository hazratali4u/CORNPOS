<%@ Page Title="CORN :: Section Wise Purchase Report" Language="C#" MasterPageFile="~/Forms/PageMaster.master"
    AutoEventWireup="true" CodeFile="rptSectionWisePurchase.aspx.cs" Inherits="Forms_rptSectionWisePurchase" %>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <br>
                                        <asp:CheckBox ID="cbhAllSection" runat="server" Text="All Sections" Checked="true" AutoPostBack="true"
                                            OnCheckedChanged="cbhAllSection_CheckedChanged"></asp:CheckBox>
                                            <br />
                                            <asp:Panel ID="pnlSection" runat="server" Height="150px" ScrollBars="Vertical" BorderColor="Silver" BorderStyle="Groove" BorderWidth="1px">
                                                <asp:CheckBoxList ID="cblSection" runat="server" ></asp:CheckBoxList>
                                            </asp:Panel>
                                    </div>
                                </div>
                                <div class="row">
