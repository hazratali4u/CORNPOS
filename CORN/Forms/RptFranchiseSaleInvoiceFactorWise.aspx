<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
     CodeFile="RptFranchiseSaleInvoiceFactorWise.aspx.cs" Inherits="Forms_RptFranchiseSaleInvoiceFactorWise"
     Title="CORN :: Franchise Sale Invoice (Factor Wise)" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="row"  style="display:none;">
                        <div class="col-md-4">
                            ...
                            <asp:Label ID="lbltoLocation" runat="server" Text="From Location" Font-Bold="true"></asp:Label>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <sapn class="fa fa-caret-right rgt_cart"></sapn>
                            <asp:Label ID="Label1" runat="server" Text="Branch / Franchise" Font-Bold="true"></asp:Label>
                            <dx:ASPxComboBox ID="drpFranchise" runat="server" CssClass="form-control">
                            </dx:ASPxComboBox>
                        </div>
                    </div>
                    <div class="row">
