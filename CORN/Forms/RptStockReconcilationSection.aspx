<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="RptStockReconcilationSection.aspx.cs" Inherits="Forms_RptStockReconcilationSection"
    Title="CORN :: Stock Reconciliation Section Wise" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="cphPage">
    <script language="JavaScript" type="text/javascript">
        ...
        function CheckBoxListSelect() {
            var chkBoxList = document.getElementById('<%= cblSection.ClientID %>');
                        ...
                        <div class="col-md-5">
                            <strong>
                                <asp:Label ID="Label11" runat="server" Width="100%" Font-Bold="True"
                                    Text="Section Name"></asp:Label></strong>
                            <br>
                            ...
                            <asp:Panel ID="Panel1" runat="server" Width="320px" Height="250px" ScrollBars="Vertical"
                                ...
                                <asp:CheckBoxList ID="cblSection" onclick="UnCheckSelectAll()" runat="server" Width="300px" Font-Size="11pt">
                                </asp:CheckBoxList>
                            </asp:Panel>
                        </div>
                    </div>
