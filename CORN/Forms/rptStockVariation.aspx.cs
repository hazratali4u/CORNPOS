...
public partial class Forms_rptStockVariation : System.Web.UI.Page
{
    /// <summary>
    /// Page_Load Function
    /// </summary>
    ...
    private void showReport(int reporType)
    {
        ...
        DataSet ds = RptInventoryCtl.GetStockVariation(int.Parse(drpDistributor.SelectedItem.Value.ToString()), DateTime.Parse(txtStartDate.Text));
