<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="frmPurchaseAuto.aspx.cs" Inherits="Forms_frmPurchaseAuto" Title="CORN :: Purchase" %>
                ...
                <ContentTemplate>
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <label><span class="fa fa-caret-right rgt_cart"></span>Purchase From</label>
                            <dx:ASPxComboBox ID="DrpTransferFrom" runat="server" CssClass="form-control"
                                Enabled="false">
                            </dx:ASPxComboBox>
                            <label><span class="fa fa-caret-right rgt_cart"></span>Purchase To</label>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <asp:Panel ID="Panel2" runat="server" Height="200px" ScrollBars="Vertical"
                                    ...
                                    <asp:GridView ID="GrdPurchase" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover table-condensed cf" Width="100%">
                                        <Columns>
                                ...
                                <div class="row" style="margin-top: 15px">
                                    <div class="col-md-12 ">
                                        <div class="btnlist pull-right">
                                            <asp:Button AccessKey="S" ID="btnSavePurchase" runat="server" Text="Save Purchase"
                                                UseSubmitBehavior="False" OnClick="btnSavePurchase_Click" CssClass="btn btn-success"></asp:Button>
