...
public partial class Forms_rptProfitLossAKFood : System.Web.UI.Page
{
    ...
    private void ShowReport(int reportType)
    {
        ...
        DataSet ds = _rptSaleCtl.SelectRptGrossProfitCrossTabAKFood(location, Convert.ToInt32(Session["UserID"]), DateTime.Parse(txtStartDate.Text), DateTime.Parse(txtEndDate.Text));
