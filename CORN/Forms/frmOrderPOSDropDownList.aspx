<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false"
    CodeFile="frmOrderPOSDropDownList.aspx.cs"
    Inherits="Forms_frmOrderPOSDropDownList"
...
<body onload="BillTime()">
    <form id="Form1" method="POST" runat="server">
        ...
        <div class="container" style="margin-bottom: 5px;">
            <div class="row">
                <div class="s1-left">
                    ...
                    <div class="s1-center">
                        <div class="order-tab" style="border-radius: 5px !important; height: 66px; background-color: #ffffff; cursor: auto; width: 30%;">
                        ...
                        <div class="order-tab" style="background: white;">
                            ...
                            <span class="order-tab-blk">
                                <asp:TextBox runat="server" ID="txtManualOrderNo" Width="88%" Height="25px" MaxLength="10" onclick="ShowCustomKeyBoad(this);"></asp:TextBox>
                            </span>
                        </div>
                        <div class="order-tab" style="background: white;">
                        ...
                        <div class="order-tab" style="background: white;">
                            ...
                            <span class="order-tab-blk">
                                <asp:TextBox runat="server" ID="txtCoverTable" Width="88%" Height="25px" MaxLength="4"
                                    onkeypress="return onlyNumbers(this,event);" onclick="ShowCustomKeyBoad(this);"></asp:TextBox>
                            </span>
                        </div>
                        <div class="clear"></div>
                    </div>
                ...
                <div class="col-md-6 gray-bg" style="height: 87.5vh; border-radius: 4px;">
                    <div class="col-md-12 delivery_main">
                        <div class="btn-bg">
                            ...
                            <div id="divCustomer" style="min-width: 190%; z-index: 5000; top: -8vh; left: 3.5%; position: absolute; background-color: rgb(198, 198, 198); padding: 0px 10px 10px; border: 1px solid rgb(0, 0, 0); max-width: 190%; visibility: visible; border-radius: 7px; visibility: hidden;">
                                <div class="row">
                                ...
                                <table style="width: 100%;">
                                    <tr>
                                        <td style="width: 55%; padding-right: 10px;">
                                            <label id="lblSKUCode" style="font-weight: normal;">Item Description</label>
                                            <br />
                                            <span class="order-tab-blk" style="text-align: left;">
                                                <asp:DropDownList ID="ddlItem" runat="server" Width="100%"></asp:DropDownList>
                                        ...
                                        <td style="width: 15%; padding-right: 10px;">
                                            ...
                                            <br />
                                            <span class="order-tab-blk">
                                                <asp:TextBox runat="server" ID="txtSKUPrice" Width="100%" Height="25px" ReadOnly="true" onkeypress="AddProductToGrid(event);" onfocus="QtyFocused(this,event);" onmouseup="return false;"></asp:TextBox>
                                            </span>
                                        </td>
                                        <td style="width: 15%">
                                            ...
                                            <br />
                                            <span class="order-tab-blk">
                                                <asp:TextBox runat="server" ID="txtQuantity" Width="90%" Height="25px" onkeypress="AddProductToGrid(event);" onfocus="QtyFocused(this,event);" onmouseup="return false;"></asp:TextBox>
                                            </span>
                                        </td>
                                        <td style="width: 15%">
                                            <label id="lblDiscount" style="font-weight: normal;">Discount</label>
                                            <br />
                                            <span class="order-tab-blk">
                                                <asp:TextBox runat="server" ID="txtItemDiscount" Width="90%" Height="25px" onkeypress="AddProductToGrid(event);" onfocus="QtyFocused(this,event);" onmouseup="return false;" disabled="disabled"></asp:TextBox>
                                            </span>
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <div class="col-md-12 item_pd_top" style="padding-right: 0px; height: 72vh">
                        <div class="col-md-12 table-top item_pd_left">
                            <div class="table-bar">
                                <div class="emp-table scrolla" style="height: 58vh;">
                                    <table class="table table-striped table-bordered table-hover table-condensed cf">
                                        <thead class="cf head" style="background-color: #7dab49;">
                                            <tr>
                                                ...
                                                <th class="numeric table-text-head">Discount
                                                </th>
                ...
                <div class="col-md-6 gray-bg" style="height: 86.5vh; border-bottom-right-radius: 10px">
                    <div class="col-md-12">
                        <div class=" btn-bg">
                    ...
                    <div class="col-md-12 table-top item_pd_left" style="padding-top: 0px; padding-bottom: 10px; height: 72vh">
                        ...
                        <div class="table-bar" style="height: 69.5vh">
                            <div class="col-md-7 vac-det" style="border-right: 1px solid cadetblue; height: 62vh;" id="dvTableList">
                                <div style="background-color: #7dab49; padding: 5px 0px 5px 30px; color: #fff;">
                                    <input type="text" id="txtVacantTable" runat="server"
                                        class="form-control" placeholder="VACANT TABLES" style="width: 94%; height: 24px;" />
                                </div>
                                <div class="col-md-12 height-180 table-bar scrolla" style="height: 58vh;">
                            ...
                            <div class="col-md-5 vac-det " id="dvPendingBills" style="height: 61vh;">
                                <div style="background-color: #7dab49; padding: 5px 0px 5px 30px; color: #fff;">
                                    <input type="text" id="txtPendingBills" runat="server"
                                        class="form-control" placeholder="PENDING BILLS" style="width: 94%; height: 24px;" />
                                </div>
                                <div class="height-180 scrolla peb" style="width: 100%; height: 57.5vh;">
                            ...
                            <table id="invoiceDetail">
                                ...
                                <tfoot id="invoiceDetailFoot">
                                    ...
                                    <tr id="trExcusiveSalesTax" style="display: none;">
                                        <td colspan="3" align="right" id="tdExclusiveTax">
                                            <label>
                                    ...
                                    <tr id="trOrderNotes">
                                        <td colspan="7" style="font-size: 10px;" id="tdNotes">
                                    ...
                                    <tr>
                                        <td colspan="7" style="font-size: 10px;" id="tdCompany">
        ...
        <script type="text/javascript" src="../AjaxLibrary/order-posDropDownList20260218.js"></script>
