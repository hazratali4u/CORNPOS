<%@ Page Title="CORN :: Section Wise Sales Report" Language="C#" MasterPageFile="~/Forms/PageMaster.master"
    AutoEventWireup="true" CodeFile="rptSectionWiseSale.aspx.cs" Inherits="Forms_rptSectionWiseSale" %>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <asp:CheckBox ID="cbhAllSection" runat="server" Text="All Sections" Checked="true" AutoPostBack="true"
                                            ...
                                            <br />
                                            <asp:Panel ID="pnlSection" runat="server" Height="150px" ScrollBars="Vertical" BorderStyle="Groove" BorderWidth="1px">
