...
public partial class Forms_RptSupplierPaymentDetailDateWise : System.Web.UI.Page
{
    ...
    private void showReport(int reportType)
    {
        ...
        ds = RptCustCtl.GetSupplierPaymentDetailDateWise(VendorID, int.Parse(drpDistributor.SelectedItem.Value.ToString()),
        ...
        CrpSupplierStatmentDetailReport CrpReport = new CrpSupplierStatmentDetailReport();
