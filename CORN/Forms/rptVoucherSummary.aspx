<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="rptVoucherSummary.aspx.cs" Inherits="Forms_rptVoucherSummary" Title="CORN :: Voucher Summary Report" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="cphPage">
    ...
    <div class="main-contents">
        <div class="container employee-infomation">
            ...
            <div class="row">
                <div class="col-md-4">
                    <asp:Button ID="btnView" runat="server" CssClass="btn btn-success" OnClick="btnView_Click" Text="View PDF" />
