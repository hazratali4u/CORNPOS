<%@ Page Language="C#" Title="CORN :: Dashboard" MasterPageFile="~/Forms/PageMaster.master"
    AutoEventWireup="true" CodeFile="frmDashBoard4.aspx.cs" Inherits="Forms_frmDashBoard4" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphPage" runat="Server">
    ...
    <table width="100%">
        ...
        <tr>
            <td style="width:10%;">
                <asp:DropDownList ID="ddlDashboardType" runat="server">
                    <asp:ListItem Value="1" Text="All" Selected="True"></asp:ListItem>
                    <asp:ListItem Value="2" Text="Dine In"></asp:ListItem>
                    <asp:ListItem Value="3" Text="Delivery"></asp:ListItem>
                    <asp:ListItem Value="4" Text="Takeaway"></asp:ListItem>
                </asp:DropDownList>
            </td>
            <td style="width:5%;" valign="top">                
            </td>
