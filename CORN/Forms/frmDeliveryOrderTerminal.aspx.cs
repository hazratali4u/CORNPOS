...
public partial class Forms_frmDeliveryOrderTerminal : System.Web.UI.Page
{
    ...
    public static string LoadSaleForce()
    {
        ...
        DataTable dt = mDController.SelectSaleForceAssignedArea(Constants.SALES_FORCE_DELIVERYMAN, int.Parse(HttpContext.Current.Session["DISTRIBUTOR_ID"].ToString()), Constants.IntNullValue, int.Parse(HttpContext.Current.Session["companyId"].ToString()), Constants.IntNullValue);
        return GetJson(dt);
    }
    ...
    public static string SelectPendingBills()
    {
        ...
        DataTable dtSkus = mSkuController.SelectPendingBills(Constants.LongNullValue,DateTime.Parse(HttpContext.Current.Session["CurrentWorkDate"].ToString()), int.Parse(HttpContext.Current.Session["DISTRIBUTOR_ID"].ToString()),Constants.IntNullValue, Constants.IntNullValue, 5);
    ...
    [WebMethod]
    [ScriptMethod]
    public static string UpdateOrder(string InvoiceId,string delivrymanID)
    {
        ...
        try
        {
            ...
            dtReturn = order.UpdateOrder(long.Parse(InvoiceId), userId, Convert.ToInt32(delivrymanID), distributerId,1);
