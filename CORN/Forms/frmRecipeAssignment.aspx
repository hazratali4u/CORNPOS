<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true" CodeFile="frmRecipeAssignment.aspx.cs"
    Inherits="Forms_frmRecipeAssignment" Title="CORN :: Recipe Assignment" %>
                                ...
                                <div class="panel panel-default">                                    
                                    <div class="panel-body">
                                        <div class="module_contents">
                                            <div class="col-md-5">        
                                                <label>UnAssigned Recipe</label>                                        
                                                <asp:ListBox ID="lstUnAssignRecipe" runat="server"
                                            ...
                                            <div class="col-md-2">
                                                <div class="navs navslist">
                                                    ...
                                                    <div class="nxt arrow">
                                                        <span>
                                                            <asp:LinkButton ID="btnAssignAllRecipe" OnClick="btnAssignAllRecipe_Click"
                                                                CssClass="fa  fa-angle-double-right" runat="server" TabIndex="9" /></span>
                                                    </div>
                                                    <div class="nxt arrow">
                                                        <span>
                                                            <asp:LinkButton ID="btnUnAssignAllRecipe" OnClick="btnUnAssignAllRecipe_Click"
                                                                CssClass="fa  fa-angle-double-left" runat="server" TabIndex="10" /></span>
                                                    </div>                                                    
                                                    <div class="nxt arrow">
                                                        <span>
                                            ...
                                            <div class="col-md-5">
                                                <label></span>Assigned Recipe</label>                                        
                                                <asp:ListBox ID="lstAssignRecipe" runat="server"
