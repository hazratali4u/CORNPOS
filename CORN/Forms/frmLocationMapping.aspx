<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true" CodeFile="frmLocationMapping.aspx.cs"
    Inherits="Forms_frmLocationMapping" Title="CORN :: Location Mapping" %>
                ...
                <div class="main-contents">
                    <div class="container user_assignment">
                        <div class="row top">
                            <div class="col-md-3">
                                <label>
                                    <span class="fa fa-caret-right rgt_cart"></span>Warehouse</label>
