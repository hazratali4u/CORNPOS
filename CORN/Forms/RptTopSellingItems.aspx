<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
     CodeFile="RptTopSellingItems.aspx.cs" Inherits="Forms_RptTopSellingItems"
     Title="CORN :: Top Selling Items" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <asp:RadioButtonList ID="RbReportType" Width="100%" runat="server" RepeatDirection="Horizontal"
                                ...
                                <asp:ListItem Value="1" Selected="True" Text="Item Wise" />
                                <asp:ListItem Value="2" Text="Category Wise" />
                            </asp:RadioButtonList>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <sapn class="fa fa-caret-right rgt_cart"></sapn>
                            <asp:Label ID="Label1" runat="server" Text="Descending By" Font-Bold="true"></asp:Label>
                            <dx:ASPxComboBox ID="drpOrderBy" runat="server" CssClass="form-control">
                                <Items>
                                    <dx:ListEditItem Text="Amount" Value="1" Selected="true" />
                                    <dx:ListEditItem Text="Qty" Value="2" />
                                </Items>
                            </dx:ASPxComboBox>
                        </div>
                    </div>
