...
public partial class Forms_Default2 : System.Web.UI.Page
{
    ...
    {
        CrpReport = (ReportDocument)this.Session["CrpReport2"];
        byte[] byteArray = null;
        try
        {
            if (int.Parse(this.Session["ReportType2"].ToString()) == 0)
            {
        ...
        finally
        {
            ...
            if (this.Session["CrpReport2"] != null)
            {
                this.Session.Remove("CrpReport2");
            }
            if (oStream != null)
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        try
        {
            if (this.CrpReport != null)
            {
                ...
                if(Session["CrpReport2"] != null)
                {
                    Session.Remove("CrpReport2");
                }
            }
