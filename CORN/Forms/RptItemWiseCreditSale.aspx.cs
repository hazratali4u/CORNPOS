...
/// </summary>
public partial class Forms_RptItemWiseCreditSale : Page
{
    ...
    {
            DataSet ds = _rptSaleCtl.SelectItemWiseCreditSale(drpDistributor.SelectedItem.Value.ToString(),DateTime.Parse(txtStartDate.Text + " 00:00:00"),DateTime.Parse(txtEndDate.Text + " 23:59:59"),int.Parse(Session["UserId"].ToString()));
            CrpItemWiseCredit crpReport = new CrpItemWiseCredit();
            ...
            crpReport.SetParameterValue("ReportName", "Item Wise Credit Sale");
