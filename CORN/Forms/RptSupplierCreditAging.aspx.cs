...
/// </summary>
public partial class Forms_RptSupplierCreditAging : System.Web.UI.Page
{
    ...
    private void showReport(int reportType)
    {
        ...
        ds = RptCustCtl.GetSupplierAgeingInvoiceWise(sbVendorID.ToString(),sbLocationIDs.ToString(), DateTime.Parse(txtStartDate.Text + " 00:00:00"),TypeID);
        DataTable dt = DPrint.SelectReportTitle(int.Parse(drpDistributor.SelectedItem.Value.ToString()));
        CrpInvoiceWiseSupplierAgeing CrpReport = new CrpInvoiceWiseSupplierAgeing();
