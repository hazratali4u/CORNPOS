<%@ Page Title="CORN :: Open Orders Detail" Language="C#" MasterPageFile="~/Forms/PageMaster.master"
    AutoEventWireup="true" CodeFile="rptOpenOrders.aspx.cs" Inherits="Forms_rptOpenOrders" %>
                                ...
                                <asp:Panel ID="Panel2" runat="server" Width="100%" Height="200px" ScrollBars="Auto">
                                    <asp:GridView ID="Grid_users" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="MANUAL_ORDER_NO" HeaderText="KOT No">
                                                <ItemStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Left" />
                                            </asp:BoundField>
                                             <asp:BoundField DataField="BILL TIME" HeaderText="Time">
                                                <ItemStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="CustomerType" HeaderText="Service Type">
                                                <ItemStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            ...
                                            <asp:BoundField DataField="SALE_INVOICE_ID2" HeaderText="SALE_INVOICE_ID2">
                                                <ItemStyle CssClass="HidePanel"/>
                                                <HeaderStyle CssClass="HidePanel" />
                                            </asp:BoundField>
                                        </Columns>
