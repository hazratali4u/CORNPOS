<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
     CodeFile="RptFranchiseSalesSummary.aspx.cs" Inherits="Forms_RptFranchiseSalesSummary" Title="CORN :: Franchise Sales Summary" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <sapn class="fa fa-caret-right rgt_cart"></sapn>
                            <asp:Label ID="lblFranchise" runat="server" Text="Franchise" Font-Bold="true"></asp:Label>
                            <dx:ASPxComboBox ID="ddlFranchise" runat="server" CssClass="form-control">
                            </dx:ASPxComboBox>
                        </div>
                    </div>
                    <div class="row">
