...
/// </summary>
public partial class Forms_rptClosingStockSummary : System.Web.UI.Page
{
    /// <summary>
    /// Page_Load Function
    /// </summary>
    ...
    private void showReport(int reporType)
    {
        ...
        DataSet ds = RptInventoryCtl.GetClosingStockSummary(distributorIds, DateTime.Parse(txtStartDate.Text), DateTime.Parse(txtEndDate.Text),sectionIDs);

        ReportDocument CrpReport = new ReportDocument();
        CrpReport = new CORNBusinessLayer.Reports.CrpClosingStockSummary();
        ...
        CrpReport.SetParameterValue("ReportType", "Closing Stock Summary Report");
