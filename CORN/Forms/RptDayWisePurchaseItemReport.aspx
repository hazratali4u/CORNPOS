<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="RptDayWisePurchaseItemReport.aspx.cs" Inherits="Forms_RptDayWisePurchaseItemReport" Title="CORN :: Purchase Report" %>
        ...
        <div class="row">
            <div class="col-md-offset-1 col-md-3 ">
                <div class="btnlist pull-right">
                    ...
                    <asp:Button ID="btnViewExcel" Visible="false" runat="server" OnClick="btnViewExcel_Click" Text="View Excel" CssClass=" btn btn-success" />
                </div>
            </div>
        </div>
    </div>
