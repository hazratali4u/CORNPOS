<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="frmStockAdjustment.aspx.cs" Inherits="Forms_frmStockAdjustment" Title="CORN :: Stock Adjustment" %>
        ...
        <div class="container">            
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <label><span class="fa fa-caret-right rgt_cart"></span>Transaction Type &nbsp;&nbsp;&nbsp; <asp:LinkButton ID="lnkImport" runat="server" Text="Import Short" OnClick="lnkImport_Click"></asp:LinkButton></label>                           
                    ...
                    <ajaxToolkit:ModalPopupExtender ID="mPOPImport" runat="server" PopupControlID="pnlImportForm"
                                                TargetControlID="lnkImport" BehaviorID="ModelPopup" BackgroundCssClass="modal-background"
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <h1 class="modal-title" id="myModalLabel1">
                                                                <span></span>
                                                                <asp:Label ID="lblTitle" runat="server" Text="Import Short"></asp:Label> 
                                                            </h1>
                                                        </div>
                    ...
                    <div class="row center">
                        <div class="col-md-12">
                            <div class="emp-table">
                                ...
                                <asp:Panel ID="Panel2" runat="server" Width="50%" Height="180px" ScrollBars="Vertical"
