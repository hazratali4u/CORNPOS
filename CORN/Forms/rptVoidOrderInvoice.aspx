<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="rptVoidOrderInvoice.aspx.cs" Inherits="Forms_rptVoidOrderInvoice" Title="CORN :: Void Order & Void Invoice Report" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <asp:CheckBox ID="ChbSelectAll" onclick="CheckBoxListSelect()" runat="server" Width="100%" Font-Size="11pt" Text="SelectAll" Checked="true"></asp:CheckBox>
                     ...
                     <div class="row">
                        <div class="col-md-4">
                            ...
                            <dx:ASPxComboBox ID="RbReportType" runat="server" CssClass="form-control"
                                SelectedIndex="0">
                                <Items>
                                    <dx:ListEditItem Value="1" Selected="True" Text="Invoice" />
                                    <dx:ListEditItem Value="2" Text="Order" />
                                </Items>
                            </dx:ASPxComboBox>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <sapn class="fa fa-caret-right rgt_cart"></sapn>
                            <asp:Label ID="Label1" runat="server" Text="Report Type" Font-Bold="true"></asp:Label>
                            <asp:RadioButtonList ID="rdoSubType" Width="100%" runat="server" RepeatDirection="Horizontal">
                                    <asp:ListItem Value="0" Selected="True" Text="Summary" />
                                    <asp:ListItem Value="1" Text="Invoice Wise" />
                            </asp:RadioButtonList>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <cc1:CalendarExtender ID="CEStartDate" runat="server" Format="dd-MMM-yyyy" PopupButtonID="ibtnStartDate"
                        PopupPosition="TopLeft" TargetControlID="txtStartDate" OnClientShown="calendarShown"></cc1:CalendarExtender>
