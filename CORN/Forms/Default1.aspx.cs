...
public partial class Forms_Default1 : System.Web.UI.Page
{
    ReportDocument CrpReport = null;
    System.IO.Stream oStream = null;
    protected void Page_Load(object sender, EventArgs e)
    {
        CrpReport = (ReportDocument)this.Session["CrpReport1"];
        byte[] byteArray = null;
        try
        {
            if (int.Parse(this.Session["ReportType1"].ToString()) == 0)
            {
            ...
            CrpReport.Close();
            CrpReport.Dispose();
            this.Session.Remove("CrpReport1");
            oStream.Close();
            oStream.Dispose();
            GC.Collect();
        ...
        finally
        {
            ...
            if (this.Session["CrpReport1"] != null)
            {
                this.Session.Remove("CrpReport1");
            }
            if (oStream != null)
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        try
        {
            if (this.CrpReport != null)
            {
                ...
                if(Session["CrpReport1"] != null)
                {
                    Session.Remove("CrpReport1");
                }
            }
