<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="rptItemCancelDeleteLog.aspx.cs" Inherits="Forms_rptItemCancelDeleteLog" Title="CORN :: Item Cancel/Less Report" %>
                        ...
                        <div class="col-md-4">
                            ...
                            <dx:ASPxComboBox ID="RbReportType" runat="server" CssClass="form-control">
                                <Items>
                                    ...
                                    <dx:ListEditItem Value="2" Text="Item Cancel" />
                                    <dx:ListEditItem Value="3" Text="Item Less" />
                                </Items>
                            </dx:ASPxComboBox>
                        </div>
                    </div>
