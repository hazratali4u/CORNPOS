<%@ Page Language="C#" Title="CORN :: BOM Issuance" AutoEventWireup="true" CodeFile="frmBOMIssuance.aspx.cs"
    Inherits="Forms_frmBOMIssuance" MasterPageFile="~/Forms/PageMaster.master" %>
                ...
                <div class="btnlist pull-right">
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:Panel ID="pnlParameters" runat="server" Style="display: none;" Width="100%" ScrollBars="Auto" DefaultButton="btnSave">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-5">
                                                            ...
                                                            <dx:ASPxComboBox ID="ddlRecipeItem" runat="server" CssClass="form-control" AutoPostBack="true"
                                                                OnSelectedIndexChanged="ddlRecipeItem_SelectedIndexChanged">
                                                            </dx:ASPxComboBox>
                                                        </div>
                                                        <div class="col-md-2">
                                                        ...
                                                        <div class="col-md-2">
                                                            <label><span class="fa fa-caret-right rgt_cart"></span>Plan Qty</label>
                                                            <asp:TextBox ID="txtRecipeQty" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                                                        </div>
                                                        <div class="col-md-1">
                                                            <%--<label><span class="fa fa-caret-right rgt_cart"></span>Qty</label>--%>
                                                            <asp:TextBox ID="txtIssueQty" runat="server" CssClass="form-control" Visible="false"></asp:TextBox>
                                                        </div>
                                                        <div class="col-md-1" style="margin-top:20px;">                                          
                                                            <asp:Button ID="btnApplye" runat="server" Text="Apply" CssClass="btn btn-success" Visible="false"
                                                                    OnClick="btnApplye_Click"/>
                                                        </div>                                                        
                                                    </div>                                                                                                        
                                                    <asp:HiddenField ID="RowId" Value="0" runat="server" />
                                                    <asp:Panel ID="pnlSKU" runat="server" Width="92%" Height="180px"
                                                        ...
                                                        <asp:GridView Width="100%" ID="gvSKU" runat="server" Class="table table-striped table-bordered table-hover table-condensed cf"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField HeaderText="Plan Qty" DataField="QUANTITY" ReadOnly="true">
                                                                    <HeaderStyle CssClass="HidePanel"></HeaderStyle>
                                                                    <ItemStyle CssClass="HidePanel"></ItemStyle>
                                                                </asp:BoundField>
                                                                <asp:BoundField HeaderText="Req. Qty" DataField="QUANTITY" ReadOnly="true">
                                                                ...
                                                                <asp:BoundField DataField="ActulQty" ReadOnly="true">
                                                                    <HeaderStyle CssClass="HidePanel"></HeaderStyle>
                                                                    <ItemStyle CssClass="HidePanel"></ItemStyle>
                                                                </asp:BoundField>                                               
                                                                <asp:TemplateField>
                                                                    ...
                                                                    <ItemStyle HorizontalAlign="Center" Width="5%" CssClass="hidden" />
                    ...
                    <asp:UpdatePanel ID="up" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="GrdRecipe" AllowPaging="true" runat="server"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="lngBOMIssuanceCode" HeaderText="ID" ReadOnly="true">
                                        <ItemStyle Width="20%" />
                                    </asp:BoundField>
                                    ...
                                    <asp:BoundField DataField="ProductionPlanID" ReadOnly="true">
                                        <ItemStyle CssClass="HidePanel" />
                                        <HeaderStyle CssClass="HidePanel" />
                                    </asp:BoundField>
                                     <asp:BoundField DataField="Recipe_Qty" HeaderText="Plan Qty" ReadOnly="true">
                                        <ItemStyle Width="10%" />
                                    </asp:BoundField>
                                    <asp:TemplateField>
