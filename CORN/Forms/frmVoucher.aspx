<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="frmVoucher.aspx.cs" Inherits="Forms_frmVoucher" Title="CORN :: Voucher Entry" %>
                ...
                <div class="emp-table">
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <dx:ASPxComboBox runat="server" ID="drpDistributor" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="drpDistributor_SelectedIndexChanged">
                                    </dx:ASPxComboBox>
                                </div>
                                <div class="col-md-2">
