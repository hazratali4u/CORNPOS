<%@ Page Title="Service Type Wise Sales" Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true" CodeFile="RptServiceWiseSales.aspx.cs" Inherits="Forms_RptCustomerWiseSale" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <asp:RadioButtonList ID="RblReportType" runat="server" Width="280px" RepeatDirection="Horizontal"
                                ...
                                <asp:ListItem Value="2" Text="Item Wise" />
                            </asp:RadioButtonList>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <dx:ASPxComboBox ID="drpServiceType" runat="server" CssClass="form-control"
                                SelectedIndex="0">
                                <Items>
                                    <dx:ListEditItem Selected="True" Value="" Text="All"></dx:ListEditItem>
                                    <dx:ListEditItem Value="1" Text="DineIn"></dx:ListEditItem>
                                    <dx:ListEditItem Value="2" Text="Delivery"></dx:ListEditItem>
                                    <dx:ListEditItem Value="3" Text="Takeaway"></dx:ListEditItem>
                                </Items>
                            </dx:ASPxComboBox>
                        </div>
                    </div>
                    ...
                    <div class="row" id="divSortBy" runat="server" visible="false">
                        <div class="col-md-6">
                            ...
                            <asp:RadioButtonList ID="RblSortBy" runat="server" Width="200px" RepeatDirection="Horizontal">
                                <asp:ListItem Value="0" Selected="True" Text="Service Type" />
