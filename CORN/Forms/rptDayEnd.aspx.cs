...
/// </summary>
public partial class Forms_rptDayEnd : Page
{
    ...
    private void ShowReport(int pReprotType)
    {
        ...
        DataSet ds;
        ds = _rptSaleCtl.GetDayEndData(int.Parse(drpDistributor.SelectedItem.Value.ToString()), DateTime.Parse(txtStartDate.Text + " 00:00:00"), DateTime.Parse(txtEndDate.Text + " 23:59:59"),
            int.Parse(Session["UserId"].ToString()));
        CrpDayEndData crpReport = new CrpDayEndData();
