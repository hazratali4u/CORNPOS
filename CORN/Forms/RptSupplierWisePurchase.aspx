<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="RptSupplierWisePurchase.aspx.cs" Inherits="Forms_RptSupplierWisePurchase" Title="CORN :: Supplier Wise Purchase" %>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <asp:RadioButtonList ID="RblReportType" runat="server" Width="250px" RepeatDirection="Horizontal">
                                <asp:ListItem Value="0" Selected="True" Text="Item Wise" />
                                <asp:ListItem Value="1" Text="Date Wise" />
                                <asp:ListItem Value="2" Text="Summary" />
                            </asp:RadioButtonList>
                        </div>
                    </div>
