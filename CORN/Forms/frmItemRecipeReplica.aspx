<%@ Page Title="CORN :: Item Recipe Replica" Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="frmItemRecipeReplica.aspx.cs" Inherits="Forms_frmItemRecipeReplica" %>
        ...
        <div class="container employee-infomation">
            <asp:UpdatePanel ID="pnlBillOfMaterial" runat="server">
                <ContentTemplate>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <label id="lblSKUFinishedNew"><span class="fa fa-caret-right rgt_cart"></span>Item Name</label>
                            <dx:ASPxComboBox runat="server" ID="ddlSKUFinishedNew" CssClass="form-control">
                            </dx:ASPxComboBox>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <label id="lblSKUFinished"><span class="fa fa-caret-right rgt_cart"></span>Item Name Old</label>
