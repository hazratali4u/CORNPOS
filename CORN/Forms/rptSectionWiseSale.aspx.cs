...
public partial class Forms_rptSectionWiseSale : System.Web.UI.Page
{
    ...
    private void ShowReport(int reportType)
    {
        ...
        DataSet ds = _rptSaleCtl.GetRegionItemSaleDetail(int.Parse(drpDistributor.SelectedItem.Value.ToString()), Constants.IntNullValue, int.Parse(Session["UserId"].ToString()), DateTime.Parse(txtStartDate.Text), DateTime.Parse(txtEndDate.Text), 3, sbSection.ToString());
        ...
        crpReport.SetParameterValue("ReportTitle", "Section Wise Sales Report");
