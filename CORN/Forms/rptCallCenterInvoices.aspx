<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
     CodeFile="rptCallCenterInvoices.aspx.cs" Inherits="Forms_rptCallCenterInvoices" Title="CORN :: Call Center Invoices" %>
        ...
        <div class="container employee-infomation">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <label><span class="fa fa-caret-right rgt_cart"></span>Mode Of Payment</label>
                            <dx:ASPxComboBox ID="ddlMOP" runat="server" CssClass="form-control" SelectedIndex="0">
                                <Items>                                
                                    <dx:ListEditItem Text="All" Value="-1"></dx:ListEditItem>
                                    <dx:ListEditItem Text="Cash" Value="0"></dx:ListEditItem>
                                    <dx:ListEditItem Text="Credit Card" Value="1"></dx:ListEditItem>
                                </Items>
                            </dx:ASPxComboBox>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                           <label><span class="fa fa-caret-right rgt_cart"></span>Rider</label>
                            <dx:ASPxComboBox ID="ddlRider" runat="server" CssClass="form-control">
                            </dx:ASPxComboBox>
                        </div>
                    </div>
                    <div class="row">
