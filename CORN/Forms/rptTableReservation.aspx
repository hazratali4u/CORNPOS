<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="rptTableReservation.aspx.cs" Inherits="Forms_rptTableReservation" Title="CORN :: Table Reservation Report" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <sapn class="fa fa-caret-right rgt_cart"></sapn>
                            <asp:Label ID="lblSlot" runat="server" Text="Booking Slot" Font-Bold="true"></asp:Label>
                            <dx:ASPxComboBox ID="ddlBookingSlot" runat="server" CssClass="form-control">
                            </dx:ASPxComboBox>
                        </div>
                    </div>
                    <div class="row">
