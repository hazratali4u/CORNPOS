<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
     CodeFile="RptComplimentaryItem.aspx.cs" Inherits="Forms_RptComplimentaryItem" Title="CORN :: Complimentary Item Report" %>
                        ...
                        <div class="col-md-4">
                            ...
                            <dx:ASPxComboBox ID="ddlReportType" runat="server" CssClass="form-control" SelectedIndex="0">
                                <Items>                                
                                    ...
                                    <dx:ListEditItem Text="Date Wise" Value="2"></dx:ListEditItem>
                                    <dx:ListEditItem Text="Invoice Wise" Value="3"></dx:ListEditItem>
                                    </Items>
                            </dx:ASPxComboBox>
                        </div>
                    </div>
