...
public partial class Forms_rptIncomeStatement : System.Web.UI.Page
{
    ...
    {
        DataSet ds = _rptSaleCtl.SelectRptGrossProfit(int.Parse(drpDistributor.SelectedItem.Value.ToString()), Convert.ToInt32(Session["UserID"]), DateTime.Parse(txtStartDate.Text), DateTime.Parse(txtEndDate.Text));
