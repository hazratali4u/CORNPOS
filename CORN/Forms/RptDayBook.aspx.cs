...
/// </summary>
public partial class Forms_RptDayBook : System.Web.UI.Page
{
    /// <summary>
    /// Page_Load Function
    /// </summary>
    ...
    private void ShowReport(int pReportType)
    {
        ...
        DataSet ds = rptAccountCtl.DayBookRptCocoRush(int.Parse(drpDistributor.SelectedItem.Value.ToString()), 
        ...
        CrpReport = new CORNBusinessLayer.Reports.CrpDayBook();
