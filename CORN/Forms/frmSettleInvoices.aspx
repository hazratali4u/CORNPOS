<%@ Page Title="CORN :: Invoice Wise Sales Report" Language="C#" MasterPageFile="~/Forms/PageMaster.master"
    AutoEventWireup="true" CodeFile="frmSettleInvoices.aspx.cs" Inherits="Forms_frmSettleInvoices" %>
        ...
        <div class="row">
            <div class="col-md-offset-1 col-md-3 ">
                <div class="btnlist pull-right">
                    ...
                    <asp:Button ID="btnDelete" runat="server" OnClick="btnDelete_Click" Text="Delete" CssClass=" btn btn-danger" OnClientClick="return confirmation();"/>
                </div>
            </div>
