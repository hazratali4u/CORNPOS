<%@ Page Language="C#" Title="CORN :: Production Plan" AutoEventWireup="true" CodeFile="frmProductionPlan.aspx.cs"
    Inherits="Forms_frmProductionPlan" MasterPageFile="~/Forms/PageMaster.master" %>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h1 class="modal-title" id="myModalLabel">
                                                <span></span>Add Production Plan</h1>
                                        </div>
                                            ...
                                            <ContentTemplate>
                                                <div class="modal-body">
                                                    ...
                                                    <asp:Panel ID="pnlSKU" runat="server" Width="92%" Height="180px"
                                                        ...
                                                        BorderWidth="1px">
                                                        <asp:GridView Width="100%" ID="gvSKU" runat="server" Class="table table-bordered table-hover table-condensed cf"
                                                            AutoGenerateColumns="False" OnRowEditing="gvSKU_RowEditing" OnRowDataBound="gvSKU_RowDataBound">
                                                            <Columns>
                    ...
                    <asp:UpdatePanel ID="up" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="GrdRecipe" AllowPaging="true" runat="server"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="lngProductionPlanCode" HeaderText="ID" ReadOnly="true">
                                        <ItemStyle Width="10%" />
                                    </asp:BoundField>
