<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
     CodeFile="rptDeliveryChannelSales.aspx.cs" Inherits="Forms_rptDeliveryChannelSales" Title="CORN :: Delivery Channel Wise Sales" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <dx:ASPxComboBox ID="ddlReportType" runat="server" CssClass="form-control" SelectedIndex="0">
                                <Items>                                
                                    <dx:ListEditItem Text="Summary" Value="1"></dx:ListEditItem>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                           <label><span class="fa fa-caret-right rgt_cart"></span>Delivery Channel</label>
                            <dx:ASPxComboBox ID="ddlDeliveryChannel" runat="server" CssClass="form-control">
                            </dx:ASPxComboBox>
                        </div>
                    </div>
                    <div class="row">
