<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    ...
    Title="CORN :: Stock Reconciliation" %>
                    ...
                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <asp:RadioButtonList ID="rblRate" runat="server" RepeatDirection="Horizontal" Width="300px">
                                                ...
                                                <asp:ListItem Text="Last Pur. Price" Value="2"></asp:ListItem>
                                            </asp:RadioButtonList>
                                        </div>
                                    </div>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                    <asp:CheckBox ID="chbAllSections" onclick="CheckBoxListSelectSection()" CssClass="SingleCheckbox1" runat="server" Width="100%"
                                        Font-Size="10pt" Text="Section" Checked="true"></asp:CheckBox>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <asp:CheckBox ID="cbZero" runat="server" Text="Zero Elimination" />
                                </div>
                            </div>
