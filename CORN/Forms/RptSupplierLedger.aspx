<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="RptSupplierLedger.aspx.cs" Inherits="Forms_RptLedgerReport2" Title="CORN :: Supplier Payable Ageing" %>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <asp:RadioButtonList ID="RbReportType" Width="100%" runat="server" RepeatDirection="Horizontal">
                                <asp:ListItem Value="1" Selected="True" Text="Transaction Date" />
                                <asp:ListItem Value="2" Text="Due Date" />
                            </asp:RadioButtonList>
                        </div>
                    </div>
                    <div class="row">
