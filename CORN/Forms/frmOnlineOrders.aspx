<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmOnlineOrders.aspx.cs" Inherits="Forms_frmOnlineOrders" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <title>CORN :: Online Orders</title>
...
<body onload="BillTime()">
    <form id="Form1" method="POST" runat="server">
        ...
        <asp:HiddenField runat="server" ID="hfNotificationStop" Value="1" />
        <asp:HiddenField runat="server" ID="hfOldOrdersCount" Value="0" />
                                    ...
                                    <div class="height-465 scrolla peb" style="width: 100%;">
                                        <table class="table table-striped table-bordered table-hover table-condensed cf">
                                            <thead class="cf head" style="background-color: #7dab49;">
                                                <tr>
                                                    <th class="numeric table-text-head">Location
                                                    </th>
                                                    ...
                                                    <th colspan="3" class="numeric table-text-head" style="text-align: center;">Action
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody id="tbl-online-orders">
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
