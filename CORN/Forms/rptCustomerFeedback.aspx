<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
     CodeFile="rptCustomerFeedback.aspx.cs" Inherits="Forms_rptCustomerFeedback" Title="CORN :: Customer Feedback" %>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="btnlist pull-right">
                   ...
                   &nbsp; <asp:Button ID="btnViewDigitalRpt" runat="server" OnClick="btnViewDigitalRpt_Click" Text="View Digital Report" CssClass=" btn btn-info" />
                </div>
            </div>
        </div>
    </div>
