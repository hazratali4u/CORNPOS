<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false"
    CodeFile="frmOrderPOSCallCenter.aspx.cs"
    Inherits="Forms.frmOrderPOSCallCenter"
...
<body onload="BillTime()">
    <form id="Form1" method="POST" runat="server">
        ...
        <div class="container" style="margin-bottom: 5px;">
            <div class="row">
                <div class="s1-left" style="margin-bottom: 0px;">
                    ...
                    <div class="s1-right" style="width: 15%;">
                    ...
                    <div class="s1-center" style="width: 75%;">
                        <table style="width: 100%;">
                            <tr>
                                <td style="width: 15%;">
                                ...
                                <td style="width: 15%;">
                                    <div class="order-tab" style="background: white; width: 95%">
                                        <span class="order-tab-blk">
                                            <asp:TextBox runat="server" ID="txtSearchItem" Width="95%" Height="25px" placeholder="Item Search"></asp:TextBox>
                                            <i class="fa fa-search" style="position: absolute; right: 56%; top: 50px;"></i>
                                        </span>
                                    </div>
                                </td>
                                <td style="width: 15%;">
                                    <div class="customerLedger" style="margin-top: 4%; max-width: 275px">
                                ...
                                <td style="width: 15%;">
                                    <div class="customerLedger" style="margin-top: 4%; max-width: 275px">
                                        <asp:DropDownList ID="ddlPaymentMode" runat="server" Width="100%">
                                            <asp:ListItem Value="-1" Text="Select MOP" Selected="True"></asp:ListItem>
                ...
                <div class="col-md-12 gray-bg" style="height: 87.5vh; border-radius: 4px;">
                    <div class="col-md-6 delivery_main">
                        <div class="btn-bg">
                            <asp:HiddenField runat="server" ID="hfCustomerType" Value="Delivery" />
                            <asp:HiddenField runat="server" ID="hfDefaultServiceType" Value="Deliver" />
                            <div class="box" id="lnkTakeaway" onclick="lnkCustomerType(this, 0);" style="width: 49%;">
                                <span>
                                    <img src="../images/Cus.png" alt="" /></span>
                                Takeaway
                                    <label id="lblCounter1"></label>
                            </div>
                            <div class="box" id="lnkDelivery" onclick="lnkCustomerType(this, 0);" style="width: 49%;">
                                <span>
                                    <img src="../images/delivery.png" alt="" /></span>
                                Delivery
                                    <label id="lblCounter2"></label>
                            </div>
                            <div class="divCustomer" id="divCustomer" style="min-width: 150%; z-index: 5000; top: -8vh; left: 30%; position: absolute; background-color: #c6c6c6; padding: 0px 10px 10px 10px; border: 1px solid #000; max-width: 150%; visibility: hidden; border-radius: 7px;">
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4" style="border-left: 1px solid #dadada;">
                                        <div class="row">
                                            <div class="col-md-3" style="margin-top: 7px;"></div>
                                            <div class="col-md-6" style="margin-top: 7px;">
                                                <span class="fa fa-caret-right rgt_cart"></span>
                                                <asp:Label ID="lblOrdersLabel" runat="server" Text="Total Orders:" Style="font: bold 17px sans-serif;" />
                                                <br />
                                                <asp:Label ID="lblOrdersValue" runat="server" Text="" Style="font: bold 17px sans-serif;" />
                                            </div>
                                            <div class="col-md-3" style="margin-top: 7px;"></div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6" style="margin-top: 7px;">
                                                <span class="fa fa-caret-right rgt_cart"></span>
                                                <asp:Label ID="lblAmountLabel" runat="server" Text="Orders Amount:" Style="font: bold 17px sans-serif;" />
                                                <br />
                                                <asp:Label ID="lblAmountValues" runat="server" Text="" Style="font: bold 17px sans-serif;" />
                                            </div>
                                            <div class="col-md-3" style="margin-top: 7px;"></div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6" style="margin-top: 7px;">
                                                <span class="fa fa-caret-right rgt_cart"></span>
                                                <asp:Label ID="lblFirstOrderLable" runat="server" Text="First Order Date:" Style="font: bold 17px sans-serif;" />
                                                <br />
                                                <asp:Label ID="lblFirstOrderValue" runat="server" Text="" Style="font: bold 17px sans-serif;" />
                                            </div>
                                            <div class="col-md-3" style="margin-top: 7px;"></div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6" style="margin-top: 7px;">
                                                <span class="fa fa-caret-right rgt_cart"></span>
                                                <asp:Label ID="lblLastOrderLabel" runat="server" Text="Last Order Date:" Style="font: bold 17px sans-serif;" />
                                                <br />
                                                <asp:Label ID="lblLastOrderValue" runat="server" Text="" Style="font: bold 17px sans-serif;" />
                                            </div>
                                            <div class="col-md-3" style="margin-top: 7px;"></div>
                                        </div>
                                    </div>
                        ...
                        <!--2nd level start-->
                        <div>
                            <asp:DropDownList ID="ddlParentCategory" runat="server" Width="100%" Visible="false">
                                <asp:ListItem Value="0" Text="Select Facility"></asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    ...
                    <div class="col-md-12 item_pd_top" style="padding-right: 0px; height: 47vh">
                        ...
                        <div class="col-md-6 item_pd_left">
                            <div class=" btn-bg" style="height: 12vh; margin: 1% 0px 1% 0px">
                                ...
                                <div class="box-last" id="dvPendings" style="height: 12vh; line-height: 35px">
                                    Pending Bills />
                                    <span>
                                        <img src="../images/file.png" alt="" /></span>
                                </div>
                                <div class="clear">
                                </div>
                            </div>
                ...
                <table id="SaleInvoice2">
                    ...
                    <tr>
                        <td style="text-align: right">
                            <span style="font-style: italic; font-size: 12px;">Order Time:  </span>
        ...
        <script type="text/javascript" src="../AjaxLibrary/order-posCallCenter20260212.js"></script>
        ...
        <div id="pending-bills-detail" style="width: 90%; height: 500px; padding: 10px; display: none;">
            <div class="table-bar" style="height: 500px;">
                <div class="emp-table scrolla" style="height: 496px;">
                    <table class="table table-striped table-bordered table-hover table-condensed cf">
                        <thead class="cf head" style="background-color: #7dab49;">
                            <tr>
                                <th class="numeric table-text-head">Status
                                </th>
                                <th class="numeric table-text-head">Order No
                                </th>
                                <th class="numeric table-text-head">Delivery Time
                                </th>
                                <th class="table-text-head">Customer Name
                                </th>
                                <th class="numeric table-text-head">Address
                                </th>
                                <th class="numeric table-text-head">Payment Mode
                                </th>
                            </tr>
                        </thead>
                        <tbody id="tbl-pending-bills-detail">
                        </tbody>
                    </table>
                </div>
            </div>
