    ...
    if (document.getElementById("hfBookingType").value == "0") {//For Point of Sale Screen
        $.ajax
            (
                {
                    type: "POST", //HTTP method
                    url: "frmOrderPOSCode.aspx/LoadSaleForce", //page/method name
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
...
function loadDiscountUser() {
    $.ajax
       (
           {
               type: "POST", //HTTP method
               url: "frmOrderPOSCode.aspx/LoadDiscountUser", //page/method name
               contentType: "application/json; charset=utf-8",
               dataType: "json",
...
function loadAllProducts() {
    $.ajax
        (
            {
                type: "POST", //HTTP method
                url: "frmOrderPOSCode.aspx/LoadAllProducts", //page/method name
                contentType: "application/json; charset=utf-8",
                dataType: "json",
...
function GetPendingBill(saleInvoiceMasterId) {
    ...
    $.ajax
        (
            {
                type: "POST", //HTTP method
                url: "frmOrderPOSCode.aspx/GetPendingBill", //page/method name
                contentType: "application/json; charset=utf-8",
                dataType: "json",
...
function GetPendingBills() {
    ...
    $.ajax
            (
                {
                    type: "POST", //HTTP method
                    url: "frmOrderPOSCode.aspx/SelectPendingBills", //page/method name
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({ customerType: document.getElementById("hfCustomerType").value }),
            ...
            if (pendingBills[i].SERVICE_TYPE == 'Delivery') {
                ...
                if (pendingBills[i].MANUAL_ORDER_NO != '') {
                    if (pendingBills[i].LOCKED) {
                        row = $('<tr ><td style="display:none;">' + pendingBills[i].INVOICE_ID + '</td><td class="leftval" style="background-color: #f4e27e;">' + pendingBills[i].TABLE_NO3 + '-' + pendingBills[i].MANUAL_ORDER_NO + '</td><td class="rightval" style="background-color: #f4e27e;">' + pendingBills[i].TOTAL_NET_AMOUNT + '</td><td style="display:none;">' + pendingBills[i].DISCOUNT + '</td><td style="display:none;">' + pendingBills[i].DISCOUNT_TYPE + '</td><td style="display:none;">' + pendingBills[i].coverTable + '</td><td style="display:none;">' + pendingBills[i].orderBookerId + '</td><td style="display:none;">' + pendingBills[i].approvedBy + '</td><td style="display:none;">' + pendingBills[i].SERVICE_CHARGES + '</td><td style="font-size: 12px;color: red;background-color: #f4e27e">' + diff(pendingBills[i].TIME_STAMP, document.getElementById('ct').innerHTML) + '</td><td style="display:none;">' + pendingBills[i].TABLE_NO2 + '</td><td style="display:none;">' + pendingBills[i].CUSTOMER_ID + '</td><td style="display:none;">' + pendingBills[i].CONTACT_NUMBER + '</td><td style="display:none;">' + pendingBills[i].ORDER_NO + '</td><td style="display:none;">' + pendingBills[i].TABLE_ID + '</td><td style="display:none;">' + pendingBills[i].CONTACT_NUMBER + '</td><td style="display:none;">' + pendingBills[i].CARD_NO + '</td><td style="display:none;">' + pendingBills[i].CARD_TYPE_ID + '</td><td style="display:none;">' + pendingBills[i].CARD_POINTS + '</td><td style="display:none;">' + pendingBills[i].PURCHASING + '</td><td style="display:none;">' + pendingBills[i].AMOUNT_LIMIT + '</td><td style="display:none;">' + pendingBills[i].EmpDiscountType + '</td><td style="display:none;">' + pendingBills[i].LOCKED + '</td><td style="display:none;">' + pendingBills[i].LOCKED_BY + '</td><td style="background-color: #f4e27e;" align="center" onclick="SendSMS(this);"><a href="#"><span class="fa fa-mobile"></span></a></td><td style="display:none;">' + pendingBills[i].TABLE_NO + '</td><td style="display:none;">' + pendingBills[i].ORDER_TIME + '</td><td style="display:none;">' + pendingBills[i].AMOUNTDUE + '</td></tr>');
                    }
                    else {
                        if (pendingBills[i].InvoicePrited == '1') {
                            row = $('<tr style="background-color: #6699cc;"><td style="display:none;">' + pendingBills[i].INVOICE_ID + '</td><td class="leftval">' + pendingBills[i].TABLE_NO3 + '-' + pendingBills[i].MANUAL_ORDER_NO + '</td><td class="rightval">' + pendingBills[i].TOTAL_NET_AMOUNT + '</td><td style="display:none;">' + pendingBills[i].DISCOUNT + '</td><td style="display:none;">' + pendingBills[i].DISCOUNT_TYPE + '</td><td style="display:none;">' + pendingBills[i].coverTable + '</td><td style="display:none;">' + pendingBills[i].orderBookerId + '</td><td style="display:none;">' + pendingBills[i].approvedBy + '</td><td style="display:none;">' + pendingBills[i].SERVICE_CHARGES + '</td><td style="font-size: 12px; color: red;">' + diff(pendingBills[i].TIME_STAMP, document.getElementById('ct').innerHTML) + '</td><td style="display:none;">' + pendingBills[i].TABLE_NO2 + '</td><td style="display:none;">' + pendingBills[i].CUSTOMER_ID + '</td><td style="display:none;">' + pendingBills[i].CONTACT_NUMBER + '</td><td style="display:none;">' + pendingBills[i].ORDER_NO + '</td><td style="display:none;">' + pendingBills[i].TABLE_ID + '</td><td style="display:none;">' + pendingBills[i].CONTACT_NUMBER + '</td><td style="display:none;">' + pendingBills[i].CARD_NO + '</td><td style="display:none;">' + pendingBills[i].CARD_TYPE_ID + '</td><td style="display:none;">' + pendingBills[i].CARD_POINTS + '</td><td style="display:none;">' + pendingBills[i].PURCHASING + '</td><td style="display:none;">' + pendingBills[i].AMOUNT_LIMIT + '</td><td style="display:none;">' + pendingBills[i].EmpDiscountType + '</td><td style="display:none;">' + pendingBills[i].LOCKED + '</td><td style="display:none;">' + pendingBills[i].LOCKED_BY + '</td><td align="center" onclick="SendSMS(this);"><a href="#"><span class="fa fa-mobile"></span></a></td><td style="display:none;">' + pendingBills[i].TABLE_NO + '</td><td style="display:none;">' + pendingBills[i].ORDER_TIME + '</td><td style="display:none;">' + pendingBills[i].AMOUNTDUE + '</td></tr>');
                ...
                if (pendingBills[i].MANUAL_ORDER_NO != '') {
                    if (pendingBills[i].LOCKED) {
                        row = $('<tr><td style="background-color: #f4e27e;width:20px;">' + pendingBills[i].INVOICE_ID + '</td><td class="leftval" style="background-color: #f4e27e;">' + pendingBills[i].TABLE_NO3 + '-' + pendingBills[i].MANUAL_ORDER_NO + '</td><td class="rightval" style="background-color: #f4e27e;">' + pendingBills[i].TOTAL_NET_AMOUNT + '</td><td style="display:none;">' + pendingBills[i].DISCOUNT + '</td><td style="display:none;">' + pendingBills[i].DISCOUNT_TYPE + '</td><td style="display:none;">' + pendingBills[i].coverTable + '</td><td style="display:none;">' + pendingBills[i].orderBookerId + '</td><td style="display:none;">' + pendingBills[i].approvedBy + '</td><td style="display:none;">' + pendingBills[i].SERVICE_CHARGES + '</td><td style="font-size: 12px;color: red;background-color: #f4e27e">' + diff(pendingBills[i].TIME_STAMP, document.getElementById('ct').innerHTML) + '</td><td style="display:none;">' + pendingBills[i].TABLE_NO2 + '</td><td style="display:none;">' + pendingBills[i].CUSTOMER_ID + '</td><td style="display:none;">' + pendingBills[i].CONTACT_NUMBER + '</td><td style="display:none;">' + pendingBills[i].ORDER_NO + '</td><td style="display:none;">' + pendingBills[i].TABLE_ID + '</td><td style="display:none;">' + pendingBills[i].CONTACT_NUMBER + '</td><td style="display:none;">' + pendingBills[i].CARD_NO + '</td><td style="display:none;">' + pendingBills[i].CARD_TYPE_ID + '</td><td style="display:none;">' + pendingBills[i].CARD_POINTS + '</td><td style="display:none;">' + pendingBills[i].PURCHASING + '</td><td style="display:none;">' + pendingBills[i].AMOUNT_LIMIT + '</td><td style="display:none;">' + pendingBills[i].EmpDiscountType + '</td><td style="display:none;">' + pendingBills[i].LOCKED + '</td><td style="display:none;">' + pendingBills[i].LOCKED_BY + '</td><td style="display:none;">' + pendingBills[i].TABLE_NO + '</td><td style="display:none;">' + pendingBills[i].ORDER_TIME + '</td><td style="display:none;">' + pendingBills[i].AMOUNTDUE + '</td></tr>');
                    }
                    else {
                        if (pendingBills[i].InvoicePrited == '1') {
            ...
            if ($('#hfIsNewItemAdded').val() == '0') {
                if ($('#hfDisable').val() == "1") {
                    ...
                    if (tableData.length > 0) {
                        ...
                        if ($("#hfCustomerType").val() === "Delivery") {
                            document.getElementById("lblServiceCharges2").innerHTML = 'Delivery Charges'
                            document.getElementById("lblServiceChg2").innerHTML = 'Delivery Charges'
                        }
                        else {
                            document.getElementById("lblServiceCharges2").innerHTML = 'Service Charges'
                            document.getElementById("lblServiceChg2").innerHTML = 'Service Charges'
                        }
                        $('#btnSave2').focus();
                    }
                }
    ...
    for (var j = 0; j < uniqueDeals.length; j++) {
        if (uniqueDeals[j] != 0) {
            ...
            $('#tble-ordered-products').find('tr').each(function () {
                if (checkVoid($(this).find("td:eq(14)").text())) {//CHECK IS VOID OR NOT
                    if (uniqueDeals[j] == $(this).find("td:eq(22)").text()) {
                        if (count == 0) {
                            count += 1;
                            totalamount += parseFloat($(this).find("td:eq(21)").text()) * parseFloat($(this).find("td:eq(27)").text());
                        }
                        return;
                    }
                }
...
function setTotals() {
    ...
    $('#tble-ordered-products tr').each(function (row, tr) {
        if (parseFloat($(tr).find("td:eq(22)").text()) == 0) {
            if (checkVoid($(tr).find('td:eq(14)').text())) {
                subtotal += parseFloat($(tr).find("td:eq(6)").text()) * parseFloat($(tr).find('td:eq(4) input').val());
                ItemWiseGST += parseFloat($(tr).find("td:eq(46)").text());
                itemdiscount += parseFloat($(tr).find("td:eq(47)").text());
            }
        }
    });
    if ($('#hfItemWiseGST').val() == "1") {
        ...
        if (discount > 0) {
            if (discountType == 0) {
                grandTotal = subtotal;
                discount = grandTotal * (discount / 100) + parseFloat(itemdiscount);
                if (document.getElementById("hfGSTCalculation").value == "1") {
                    ...
                    salesTax = parseFloat(salesTax) / 100 * (parseFloat(grandTotal) + parseFloat(servicecharges) - parseFloat(discount));
                }
                else {
                    salesTax = parseFloat(salesTax) / 100 * (parseFloat(grandTotal) - parseFloat(discount));
                }
                balance = Math.round((grandTotal - discount + parseFloat(servicecharges) + parseFloat(salesTax)), 0);
            }
                ...
                if (document.getElementById("hfGSTCalculation").value == "1") {
                    ...
                    salesTax = parseFloat(salesTax) / 100 * (parseFloat(grandTotal) + parseFloat(servicecharges) - (discount + parseFloat(itemdiscount)));
                }
                else {
                    salesTax = parseFloat(salesTax) / 100 * (grandTotal - (discount + parseFloat(itemdiscount)));
                }
                balance = Math.round((grandTotal - discount + parseFloat(itemdiscount) + parseFloat(servicecharges) + parseFloat(salesTax)), 0);
            }
        }
        else {
            grandTotal = subtotal;
...
function UnlockRecord() {
    $.ajax
        (
            {
                type: "POST", //HTTP method
                url: "frmOrderPOSCode.aspx/UnlockRecord", //page/method name
                contentType: "application/json; charset=utf-8",
    ...
    for (var i = 0, len = lstProducts.length; i < len; ++i) {
        if (lstProducts[i].DEAL == 1) {
            if (lstProducts[i].I_D_ID == dealId) {
                ...
                $('#tble-ordered-products').find('tr').each(function () {
                    if (checkVoid($(this).find("td:eq(14)").text())) {//CHECK IS VOID OR NOT
                        if (dealId == $(this).find("td:eq(22)").text() && lstProducts[i].DIV_ID == $(this).find("td:eq(15)").text()) {
    ...
    if ($('#txtLoyaltyCard').val() != "") {
        $.ajax
           (
               {
                   type: "POST", //HTTP method
                   url: "frmOrderPOSCode.aspx/LoadLoyaltyCardDetail", //page/method name
                   contentType: "application/json; charset=utf-8",
                   dataType: "json",
...
function plusQty(obj) {
    ...
    var cbScanValue = document.getElementById("cbScan").checked;
    if (cbScanValue) {
        return;
    }
    var rowIndex = $(obj).parent();
    var Sku_Id = $(rowIndex).find('td:eq(0)').text();
    if (checkVoid($(rowIndex).find('td:eq(14)').text())) {
    ...
    $('#tble-ordered-products tr').each(function (row, tr) {
        if ($(tr).find('td:eq(20)').text() == "2") {
            tableData[row] = {
                ...
                "PRINTER": $(tr).find('td:eq(9)').text(),
                "PR_COUNT": $(tr).find('td:eq(10)').text(),
                "SEC_ID": $(tr).find('td:eq(11)').text(),
                "SECTION": $(tr).find('td:eq(12)').text(),
                "C1": $(tr).find('td:eq(13)').text(),
                "VOID": $(tr).find('td:eq(14)').text(),
                "CAT_ID": $(tr).find('td:eq(15)').text(),
                "INVOICE_ID": $(tr).find('td:eq(16)').text(),
                "DESC": $(tr).find('td:eq(18)').text(),
                "PRINT": $(tr).find('td:eq(19)').text(),
                "A_PRICE": $(tr).find('td:eq(21)').text(),
                "I_D_ID": $(tr).find('td:eq(22)').text(),
                ...
                "PRINT_QTY": $(tr).find('td:eq(42)').text(),
                "MODIFIER_PARENT_ID": 0,
                "LessCancelReasonID": $(tr).find('td:eq(43)').text(),
                "SortOrder": $(tr).find('td:eq(44)').text(),
                "GSTPER": $(tr).find('td:eq(45)').text(),
                "ItemWiseGST": $(tr).find('td:eq(46)').text(),
                "DISCOUNT": $(tr).find('td:eq(47)').text(),
                "ItemType": 1,
                //56 For TimeStamp
...
function ShowBill(tr) {
    ...
    $('#txtDiscountAvail2').val('');
    $('#txtDiscountBalance2').val('');
    $("#lblTotalNetAmount").text($(tr).find("td:eq(2)").text());
    if (document.getElementById('hfCheckSMS').value == "0") {
        ...
        if ($(tr).find("td:eq(10)").text() == "DLY") {
            ...
            $("#OrderTime").text($(tr).find("td:eq(25)").text());
        }
        else {
...
function fnHoldOrder() {
    ...
    if (CheckCatDealQty($("#hfDealId").val())) {
        ...
        $('#tble-ordered-products tr').each(function (row, tr) {
            if (parseFloat($(tr).find("td:eq(22)").text()) == 0) {
                if (checkVoid($(tr).find('td:eq(14)').text())) {
                    subtotal += parseFloat($(tr).find("td:eq(7)").text());
                    ItemWiseGST += parseFloat($(tr).find("td:eq(46)").text());
                    itemdiscount += parseFloat($(tr).find("td:eq(47)").text());
                }
            }
        ...
        $.ajax
                ({
                    type: "POST", //HTTP method
                    url: "frmOrderPOSCode.aspx/HoldOrder", //page/method name
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
...
$('#btnVoidTakeawayOrder').click(function (e) {
    ...
    $.ajax
            ({
                type: "POST", //HTTP method
                url: "frmOrderPOSCode.aspx/VoidOrder", //page/method name
                contentType: "application/json; charset=utf-8",
                dataType: "json",
...
function CalculateBalance() {
    ...
    if (discountType == 0) {
        ...
        if (document.getElementById("hfGSTCalculation").value == "1") {
            ...
            gst = parseFloat(gst / 100) * (parseFloat(grandTotal) + parseFloat(servicecharges) - parseFloat(discount));
        }
        else {
        ...
        if (document.getElementById("hfGSTCalculation").value == "1") {
            ...
            gst = parseFloat(gst / 100) * (parseFloat(grandTotal) + parseFloat(servicecharges) - (discount + parseFloat(itemdiscount)));
        }
        else {
...
function CalculateBalance3() {
    ...
    if (discountType == 0) {
        ...
        if (document.getElementById("hfGSTCalculation").value == "1") {
            ...
            gst = parseFloat(gst / 100) * (parseFloat($("#hfGrandTotal").val()) + parseFloat(servicecharges) - parseFloat(discount));
        }
        else {
            gst = parseFloat(gst / 100) * (parseFloat($("#hfGrandTotal").val()) - parseFloat(discount));
        }
        balance = Math.round((grandTotal - discount + parseFloat(servicecharges) + parseFloat(gst)), 0);
        amountDue = Math.round(balance, 0);
        balance = cashRcd - balance;
...
function SaveInvoice(recordtype) {
    ...
    if (ValidateDiscount(EmpDiscount)) {
        ...
        (
            {
                type: "POST", //HTTP method
                url: "frmOrderPOSCode.aspx/InsertInvoice", //page/method name
                contentType: "application/json; charset=utf-8",
                dataType: "json",
...
function UserValidationInDataBase(obj) {
    ...
    $.ajax
        (
            {
                type: "POST", //HTTP method
                url: "frmOrderPOSCode.aspx/ValidateUser", //page/method name
                contentType: "application/json; charset=utf-8",
                dataType: "json",
...
function deleteItem(btn) {
    ...
    if (checkVoid($(rowIndex).find('td:eq(14)').text())) {
        ...
        var Cat_id = $(rowIndex).find('td:eq(15)').text();

        $("#hfskuId").val(Sku_id);
        $("#hfcatId").val(Cat_id);
        $("#hfDelIndex").val($(rowIndex).find('td:eq(13)').text());
...
function deleteQty() {
    ...
    $('#tble-ordered-products tr').each(function (row, tr) {
        if ($(tr).find('td:eq(0)').text() == Sku_Id && $(tr).find('td:eq(15)').text() == Cat_Id && $(tr).find('td:eq(13)').text() == C1) {
            $(tr).find('td:eq(14)').text(true);
            $(tr).find('td:eq(42)').text(0);
            $(tr).find('td:eq(8)').css('background-color', '#b20505');
            $(tr).find('td:eq(43)').text($('select#ddlCancelReason option:selected').val());
        }
    });
    var tableData = storeTblValues();
    tableData = JSON.stringify(tableData);
        ...
        if ($(tr).find('td:eq(0)').text() == Sku_Id && $(tr).find('td:eq(15)').text() == Cat_Id && $(tr).find('td:eq(13)').text() == C1) {
            ...
            if (Deal_Id != 0) {
                if (qty > parseFloat($(tr).find('td:eq(27)').text()) * parseFloat($(tr).find('td:eq(28)').text())) {
                    ...
                    $(tr).find("td:eq(47)").text(parseFloat(discount2 * nQty));
                }
            }
            else {
                if (qty == "1") {
            ...
            $(tr).find('td:eq(7)').text(parseFloat(amount) - parseFloat(discount2));
            $(tr).find('td:eq(43)').text($('select#ddlLessReason option:selected').val());
            $(tr).find('td:eq(46)').text(amount * parseFloat($(tr).find('td:eq(45)').text()) / 100);
            setTotals();
        }
    });
    var tableData = storeTblValues();
...
function CalculateBalance2() {
    ...
    if (discountType == 0) {
        ...
        if (document.getElementById("hfGSTCalculation").value == "1") {
            ...
            CalculateServiceChages();
            gst = parseFloat(gst / 100) * (parseFloat(grandTotal) + parseFloat($('#lblServiceChargesTotal').text()) - parseFloat(discount));
        }
        else {
            gst = parseFloat(gst / 100) * (parseFloat(grandTotal) - parseFloat(discount));
        }
        ...
        if (document.getElementById("hfGSTCalculation").value == "1") {
            ...
            CalculateServiceChages();
            gst = parseFloat(gst / 100) * (parseFloat(grandTotal) + parseFloat($('#lblServiceChargesTotal').text()) - (discount + parseFloat(itemdiscount)));
        }
        else {
            gst = parseFloat(gst / 100) * (parseFloat(grandTotal - (discount + parseFloat(itemdiscount))));
        }
    ...
    if (ValidateDiscount2(EmpDiscount)) {
        ...
        $.ajax
            (
                {
                    type: "POST", //HTTP method
                    url: "frmOrderPOSCode.aspx/UpdateOrder", //page/method name
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
    ...
    if (ValidateCustomer()) {
        ...
        $.ajax
            (
                {
                    type: "POST", //HTTP method
                    url: "frmOrderPOSCode.aspx/InsertCustomer", //page/method name
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
...
function LoadAllCustomers() {
    $.ajax
       (
           {
               type: "POST", //HTTP method
               url: "frmOrderPOSCode.aspx/LoadAllCustomers", //page/method name
               contentType: "application/json; charset=utf-8",
               dataType: "json",
...
function SMS(Number, Type) {
    ...
    //           {
    //               type: "POST", //HTTP method
    //               url: "frmOrderPOSCode.aspx/SendSMS", //page/method name
    //               contentType: "application/json; charset=utf-8",
    //               dataType: "json",
...
function GetSKUInfo(e) {
    ...
    if (key == 13) {
        ...
        var cbScanValue = document.getElementById("cbScan").checked;
        if (cbScanValue) {
            skuCode = $('#txtSKUCode').val().substring(0, 7);
            qty = $('#txtSKUCode').val().substring(7, 13);
            qty = qty.slice(0, 2) + "." + qty.slice(2, 6);
            $('#txtSKUCode').val(skuCode);
        } else {
            skuCode = $('#txtSKUCode').val();
        }
        if (skuCode != '') {
            var flage = false;
            var flagItemFound = false;
            var row = "";
            for (var i = 0, len = lstProducts.length; i < len; ++i) {
                if (lstProducts[i].strERPCode.toUpperCase() == skuCode.toUpperCase()) {
                    flage = false;
                    flagItemFound = true;
                    row = "";
                    $('#txtSKUName').val(lstProducts[i].SKU_NAME);
            ...
            if (!flagItemFound) {
                $('#messageBox').text('Item not found');
                $('#txtSKUCode').focus();
                return;
            }
            if ($("#hfPOSCodeAddToGrid").val() == "1") {
                fnAddProductToGrid();
            }
        }
    }
    ...
    for (var i = 0, len = lstProducts.length; i < len; ++i) {
        ...
        if (lstProducts[i].SKU_ID == skuId) {
            $('#tble-ordered-products').find('tr').each(function () {
                ...
                var tdcat = $(this).find("td:eq(15)").text();
                var tdDeal = -1;
                if ($(this).find("td:eq(22)").text() != "") {
                    tdDeal = $(this).find("td:eq(22)").text();
                }
                if (skuId == td1) {
                    ...
                    var color = $(this).find("td:eq(2)").css("color");//finding color for modifier 
                    ...
                    if (checkVoid($(this).find("td:eq(14)").text())) {//CHECK IS VOID OR NOT
                        if ($("#hfRow").val() == "") {//check row is selected or not if select not then update previous else add new
                            if (color == "rgb(255, 0, 0)") {
                                ...
                                if ($(this).find("td:eq(20)").text() == "2") {//WHEN DIVISION IS VALUE BASE
                                    $(this).find("td:eq(6) input").val(parseFloat($(this).find("td:eq(6) input").val()) + parseFloat($(this).find("td:eq(21)").text()));
                                    $(this).find("td:eq(4) input").val(parseFloat($(this).find("td:eq(6) input").val()) / parseFloat($(this).find("td:eq(21)").text()));
                                }
                                else {
                                    $(this).find("td:eq(4) input").val(parseFloat($(this).find("td:eq(4) input").val()) + parseFloat($('#txtQuantity').val()));
                                    $(this).find("td:eq(7)").text(parseFloat($(this).find("td:eq(6)").text()) * parseInt($(this).find("td:eq(4) input").val()) - parseFloat(discount));
...
function addProductToOrderedProduct(lstProducts, i, invoiceId) {
    ...
    if (lstProducts[i].T_PRICE.toString().indexOf(".") == -1) {
        ...
        amount = lstProducts[i].AMOUNT - parseFloat(discount);
    }
    else {
    ...
    if (lstProducts[i].DIV_ID == "2") {//WHEN DIVISION IS VALUE BASE FOR ALIALFAZAL
        row = $('<tr><td style="display:none;">' + lstProducts[i].SKU_ID + '</td><td>' + lstProducts[i].strERPCode + '</td><td class="table-text2">' + lstProducts[i].SKU_NAME + '<span style="color:red"> - ' + time + '</span></td><td align="center"><span style="margin-right: 5px; cursor: pointer;"><img src="../images/plus.png"></span></td> <td align="center"><input type="text" size="2" value="' + lstProducts[i].QTY + '"  style="text-align: center;" onkeyup="QtyChanged(this);" onblur="CheckQty(this);"></td><td align="center"><span style="margin-left: 5px; cursor: pointer;"><img src="../images/minus.png"></span></td><td><input type="text" size="4" onkeyup="plusAmount(this);" onkeypress="return onlyDotsAndNumbers(this, event);" value="' + tprice + '"></td><td class="table-text2">' + amount + '</td><td align="center" onclick="deleteItem(this);"><a href="#"><span class="fa fa-times"></span></a></td><td style="display:none;">' + lstProducts[i].PRINTER + '</td><td style="display:none;">' + lstProducts[i].PR_COUNT + '</td><td style="display:none;">' + lstProducts[i].SEC_ID + '</td><td style="display:none;">' + lstProducts[i].SECTION + '</td><td style="display:none;">' + lstProducts[i].C1 + '</td><td style="display:none;">' + lstProducts[i].VOID + '</td><td style="display:none;">' + lstProducts[i].CAT_ID + '</td><td style="display:none;">' + invoiceId + '</td><td style="display:none;">' + lstProducts[i].IS_DESC + '</td><td style="display:none;">' + lstProducts[i].DESC + '</td><td style="display:none;">' + lstProducts[i].PRINT + '</td><td style="display:none;">' + lstProducts[i].DIV_ID + '</td><td style="display:none;">' + lstProducts[i].A_PRICE + '</td><td style="display:none;">' + lstProducts[i].I_D_ID + '</td><td style="display:none;">' + lstProducts[i].C2 + '</td><td style="display:none;">' + lstProducts[i].H + '</td><td style="display:none;">' + lstProducts[i].intDealID + '</td><td style="display:none;">' + lstProducts[i].lngDealDetailID + '</td><td style="display:none;">' + lstProducts[i].DEAL_QTY + '</td><td style="display:none;">' + lstProducts[i].Cat_Quantity + '</td><td style="display:none;">' + lstProducts[i].Is_CatChoice + '</td><td style="display:none;">' + lstProducts[i].Is_ItemChoice + '</td><td style="display:none;">' + lstProducts[i].Is_Optional + '</td><td style="display:none;">' + lstProducts[i].DEAL_NAME + '</td><td style="display:none;">' + lstProducts[i].UOM_ID + '</td><td style="display:none;">' + lstProducts[i].intStockMUnitCode + '</td><td style="display:none;">' + lstProducts[i].Stock_to_SaleOperator + '</td><td style="display:none;">' + lstProducts[i].Stock_to_SaleFactor + '</td><td style="display:none;">' + lstProducts[i].DEFAULT_QTY + '</td><td style="display:none;">' + lstProducts[i].IS_HasMODIFIER + '</td><td style="display:none;">' + lstProducts[i].SALE_INVOICE_DETAIL_ID + '</td><td style="display:none;">' + lstProducts[i].IS_FREE + '</td><td style="display:none;">' + lstProducts[i].QTY + '</td><td style="display:none;">' + lstProducts[i].PRINT_QTY + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + lstProducts[i].GSTPER + '</td><td style="display:none;">' + gstamount + '</td><td style="display:none;">' + discount + '</td><td style="display:none;">' + lstProducts[i].TIME_STAMP3 + '</td></tr>');
    }
    else {
        if (lstProducts[i].I_D_ID == "0") {//WHEN DEALS IS OFF 
            if (lstProducts[i].MODIFIER == "0") {//CHECK IS MODIFIER OR NOT IF NOT THEN
                row = $('<tr><td style="display:none;">' + lstProducts[i].SKU_ID + '</td><td>' + lstProducts[i].strERPCode + '</td><td class="table-text2">' + lstProducts[i].SKU_NAME + '<span style="color:red"> - ' + time + '</span></td><td align="center" onclick="plusQty(this);"><span style="margin-right: 5px; cursor: pointer;"><img src="../images/plus.png"></span></td> <td align="center"><input type="text" size="2" value="' + lstProducts[i].QTY + '"  style="text-align: center;" onkeyup="QtyChanged(this);" onblur="CheckQty(this);"></td><td align="center" onclick="decreaseItem(this);"><span style="margin-left: 5px; cursor: pointer;"><img src="../images/minus.png"></span></td><td class="table-text2">' + tprice + '</td><td class="table-text2">' + amount + '</td><td align="center" onclick="deleteItem(this);"><a href="#"><span class="fa fa-times"></span></a></td><td style="display:none;">' + lstProducts[i].PRINTER + '</td><td style="display:none;">' + lstProducts[i].PR_COUNT + '</td><td style="display:none;">' + lstProducts[i].SEC_ID + '</td><td style="display:none;">' + lstProducts[i].SECTION + '</td><td style="display:none;">' + lstProducts[i].C1 + '</td><td style="display:none;">' + lstProducts[i].VOID + '</td><td style="display:none;">' + lstProducts[i].CAT_ID + '</td><td style="display:none;">' + invoiceId + '</td><td style="display:none;">' + lstProducts[i].IS_DESC + '</td><td style="display:none;">' + lstProducts[i].DESC + '</td><td style="display:none;">' + lstProducts[i].PRINT + '</td><td style="display:none;">' + lstProducts[i].DIV_ID + '</td><td style="display:none;">' + lstProducts[i].A_PRICE + '</td><td style="display:none;">' + lstProducts[i].I_D_ID + '</td><td style="display:none;">' + lstProducts[i].C2 + '</td><td style="display:none;">' + lstProducts[i].H + '</td><td style="display:none;">' + lstProducts[i].intDealID + '</td><td style="display:none;">' + lstProducts[i].lngDealDetailID + '</td><td style="display:none;">' + lstProducts[i].DEAL_QTY + '</td><td style="display:none;">' + lstProducts[i].Cat_Quantity + '</td><td style="display:none;">' + lstProducts[i].Is_CatChoice + '</td><td style="display:none;">' + lstProducts[i].Is_ItemChoice + '</td><td style="display:none;">' + lstProducts[i].Is_Optional + '</td><td style="display:none;">' + lstProducts[i].DEAL_NAME + '</td><td style="display:none;">' + lstProducts[i].UOM_ID + '</td><td style="display:none;">' + lstProducts[i].intStockMUnitCode + '</td><td style="display:none;">' + lstProducts[i].Stock_to_SaleOperator + '</td><td style="display:none;">' + lstProducts[i].Stock_to_SaleFactor + '</td><td style="display:none;">' + lstProducts[i].DEFAULT_QTY + '</td><td style="display:none;">' + lstProducts[i].IS_HasMODIFIER + '</td><td style="display:none;">' + lstProducts[i].SALE_INVOICE_DETAIL_ID + '</td><td style="display:none;">' + lstProducts[i].IS_FREE + '</td><td style="display:none;">' + lstProducts[i].ORIGINAL_QTY + '</td><td style="display:none;">' + lstProducts[i].PRINT_QTY + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + lstProducts[i].GSTPER + '</td><td style="display:none;">' + gstamount + '</td><td style="display:none;">' + discount + '</td><td style="display:none;">' + lstProducts[i].TIME_STAMP3 + '</td></tr>');
            }
            else {
                if (lstProducts[i].T_PRICE == "0") {
                    row = $('<tr><td style="display:none;">' + lstProducts[i].SKU_ID + '</td><td>' + lstProducts[i].strERPCode + '</td><td class="table-text2" style="color: red" colspan="6">' + lstProducts[i].SKU_NAME + '<span style="color:red"> - ' + time + '</span></td><td style="display:none;" onclick="plusQty(this);"><span style="margin-right: 5px; cursor: pointer;"><img src="../images/plus.png"></span></td> <td style="display:none;"><input type="text" size="2" value="' + 1 + '"  style="text-align: center;" onkeyup="QtyChanged(this);" onblur="CheckQty(this);"></td><td style="display:none;" onclick="decreaseItem(this);"><span style="margin-left: 5px; cursor: pointer;"><img src="../images/minus.png"></span></td><td style="display:none;" class="table-text2">' + tprice + '</td><td style="display:none;" class="table-text2">' + amount + '</td><td align="center" onclick="deleteItem(this);"><a href="#"><span class="fa fa-times"></span></a></td><td style="display:none;">' + lstProducts[i].PRINTER + '</td><td style="display:none;">' + lstProducts[i].PR_COUNT + '</td><td style="display:none;">' + lstProducts[i].SEC_ID + '</td><td style="display:none;">' + lstProducts[i].SECTION + '</td><td style="display:none;">' + lstProducts[i].C1 + '</td><td style="display:none;">' + lstProducts[i].VOID + '</td><td style="display:none;">' + lstProducts[i].CAT_ID + '</td><td style="display:none;">' + invoiceId + '</td><td style="display:none;">' + lstProducts[i].IS_DESC + '</td><td style="display:none;">' + lstProducts[i].DESC + '</td><td style="display:none;">' + lstProducts[i].PRINT + '</td><td style="display:none;">' + lstProducts[i].DIV_ID + '</td><td style="display:none;">' + lstProducts[i].A_PRICE + '</td><td style="display:none;">' + lstProducts[i].I_D_ID + '</td><td style="display:none;">' + lstProducts[i].C2 + '</td><td style="display:none;">' + lstProducts[i].H + '</td><td style="display:none;">' + lstProducts[i].intDealID + '</td><td style="display:none;">' + lstProducts[i].lngDealDetailID + '</td><td style="display:none;">' + lstProducts[i].DEAL_QTY + '</td><td style="display:none;">' + lstProducts[i].Cat_Quantity + '</td><td style="display:none;">' + lstProducts[i].Is_CatChoice + '</td><td style="display:none;">' + lstProducts[i].Is_ItemChoice + '</td><td style="display:none;">' + lstProducts[i].Is_Optional + '</td><td style="display:none;">' + lstProducts[i].DEAL_NAME + '</td><td style="display:none;">' + lstProducts[i].UOM_ID + '</td><td style="display:none;">' + lstProducts[i].intStockMUnitCode + '</td><td style="display:none;">' + lstProducts[i].Stock_to_SaleOperator + '</td><td style="display:none;">' + lstProducts[i].Stock_to_SaleFactor + '</td><td style="display:none;">' + lstProducts[i].DEFAULT_QTY + '</td><td style="display:none;">' + lstProducts[i].IS_HasMODIFIER + '</td><td style="display:none;">' + lstProducts[i].DeliveryType + '</td><td style="display:none;">' + lstProducts[i].SALE_INVOICE_DETAIL_ID + '</td><td style="display:none;">' + lstProducts[i].IS_FREE + '</td><td style="display:none;">' + lstProducts[i].QTY + '</td><td style="display:none;">' + lstProducts[i].PRINT_QTY + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + lstProducts[i].GSTPER + '</td><td style="display:none;">' + gstamount + '</td><td style="display:none;">' + discount + '</td><td style="display:none;">' + lstProducts[i].TIME_STAMP3 + '</td></tr>');
                }
                else {
            ...
            if (lstProducts[i].MODIFIER == "1") {
                if (lstProducts[i].T_PRICE == "0") {
                    row = $('<tr><td style="display:none;">' + lstProducts[i].SKU_ID + '</td><td>' + lstProducts[i].strERPCode + '</td><td class="table-text2" style="color: red">' + lstProducts[i].SKU_NAME + '<span style="color:red"> - ' + time + '</span></td><td style="display: none;" onclick="plusQty(this);"><span style="margin-right: 5px; cursor: pointer;"><img src="../images/plus.png"></span></td> <td align="center"><input type="text" size="2" value="' + 1 + '"  style="text-align: center;" onkeyup="QtyChanged(this);" onblur="CheckQty(this);"></td><td style="display: none;" onclick="decreaseItem(this);"><span style="margin-left: 5px; cursor: pointer;"><img src="../images/minus.png"></span></td><td class="table-text2">' + 0 + '</td><td class="table-text2">' + amount + '</td><td style="display: none;" onclick="deleteItem(this);"><a href="#"><span class="fa fa-times"></span></a></td><td style="display:none;">' + lstProducts[i].PRINTER + '</td><td style="display:none;">' + lstProducts[i].PR_COUNT + '</td><td style="display:none;">' + lstProducts[i].SEC_ID + '</td><td style="display:none;">' + lstProducts[i].SECTION + '</td><td style="display:none;">' + lstProducts[i].C1 + '</td><td style="display:none;">' + lstProducts[i].VOID + '</td><td style="display:none;">' + lstProducts[i].CAT_ID + '</td><td style="display:none;">' + invoiceId + '</td><td style="display:none;">' + lstProducts[i].IS_DESC + '</td><td style="display:none;">' + lstProducts[i].DESC + '</td><td style="display:none;">' + lstProducts[i].PRINT + '</td><td style="display:none;">' + lstProducts[i].DIV_ID + '</td><td style="display:none;">' + lstProducts[i].A_PRICE + '</td><td style="display:none;">' + lstProducts[i].I_D_ID + '</td><td style="display:none;">' + lstProducts[i].C2 + '</td><td style="display:none;">' + lstProducts[i].H + '</td><td style="display:none;">' + lstProducts[i].intDealID + '</td><td style="display:none;">' + lstProducts[i].lngDealDetailID + '</td><td style="display:none;">' + lstProducts[i].DEAL_QTY + '</td><td style="display:none;">' + lstProducts[i].Cat_Quantity + '</td><td style="display:none;">' + lstProducts[i].Is_CatChoice + '</td><td style="display:none;">' + lstProducts[i].Is_ItemChoice + '</td><td style="display:none;">' + lstProducts[i].Is_Optional + '</td><td style="display:none;">' + lstProducts[i].DEAL_NAME + '</td><td style="display:none;">' + lstProducts[i].UOM_ID + '</td><td style="display:none;">' + lstProducts[i].intStockMUnitCode + '</td><td style="display:none;">' + lstProducts[i].Stock_to_SaleOperator + '</td><td style="display:none;">' + lstProducts[i].Stock_to_SaleFactor + '</td><td style="display:none;">' + lstProducts[i].DEFAULT_QTY + '</td><td style="display:none;">' + lstProducts[i].IS_HasMODIFIER + '</td><td style="display:none;">' + lstProducts[i].DeliveryType + '</td><td style="display:none;">' + lstProducts[i].SALE_INVOICE_DETAIL_ID + '</td><td style="display:none;">' + lstProducts[i].IS_FREE + '</td><td style="display:none;">' + lstProducts[i].QTY + '</td><td style="display:none;">' + lstProducts[i].PRINT_QTY + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + lstProducts[i].GSTPER + '</td><td style="display:none;">' + gstamount + '</td><td style="display:none;">' + discount + '</td><td style="display:none;">' + lstProducts[i].TIME_STAMP3 + '</td></tr>');
                }
                else {
                    row = $('<tr><td style="display:none;">' + lstProducts[i].SKU_ID + '</td><td>' + lstProducts[i].strERPCode + '</td><td style="color: red" class="table-text2">' + lstProducts[i].SKU_NAME + '<span style="color:red"> - ' + time + '</span></td><td align="center" onclick="plusQty(this);"><span style="margin-right: 5px; cursor: pointer;"><img src="../images/plus.png"></span></td> <td align="center"><input type="text" size="2" value="' + lstProducts[i].QTY + '"  style="text-align: center;" onkeyup="QtyChanged(this);" onblur="CheckQty(this);"></td><td align="center" onclick="decreaseItem(this);"><span style="margin-left: 5px; cursor: pointer;"><img src="../images/minus.png"></span></td><td class="table-text2">' + 0 + '</td><td class="table-text2">' + amount + '</td><td align="center" onclick="deleteItem(this);"><a href="#"><span class="fa fa-times"></span></a></td><td style="display:none;">' + lstProducts[i].PRINTER + '</td><td style="display:none;">' + lstProducts[i].PR_COUNT + '</td><td style="display:none;">' + lstProducts[i].SEC_ID + '</td><td style="display:none;">' + lstProducts[i].SECTION + '</td><td style="display:none;">' + lstProducts[i].C1 + '</td><td style="display:none;">' + lstProducts[i].VOID + '</td><td style="display:none;">' + lstProducts[i].CAT_ID + '</td><td style="display:none;">' + invoiceId + '</td><td style="display:none;">' + lstProducts[i].IS_DESC + '</td><td style="display:none;">' + lstProducts[i].DESC + '</td><td style="display:none;">' + lstProducts[i].PRINT + '</td><td style="display:none;">' + lstProducts[i].DIV_ID + '</td><td style="display:none;">' + lstProducts[i].A_PRICE + '</td><td style="display:none;">' + lstProducts[i].I_D_ID + '</td><td style="display:none;">' + lstProducts[i].C2 + '</td><td style="display:none;">' + lstProducts[i].H + '</td><td style="display:none;">' + lstProducts[i].intDealID + '</td><td style="display:none;">' + lstProducts[i].lngDealDetailID + '</td><td style="display:none;">' + lstProducts[i].DEAL_QTY + '</td><td style="display:none;">' + lstProducts[i].Cat_Quantity + '</td><td style="display:none;">' + lstProducts[i].Is_CatChoice + '</td><td style="display:none;">' + lstProducts[i].Is_ItemChoice + '</td><td style="display:none;">' + lstProducts[i].Is_Optional + '</td><td style="display:none;">' + lstProducts[i].DEAL_NAME + '</td><td style="display:none;">' + lstProducts[i].UOM_ID + '</td><td style="display:none;">' + lstProducts[i].intStockMUnitCode + '</td><td style="display:none;">' + lstProducts[i].Stock_to_SaleOperator + '</td><td style="display:none;">' + lstProducts[i].Stock_to_SaleFactor + '</td><td style="display:none;">' + lstProducts[i].DEFAULT_QTY + '</td><td style="display:none;">' + lstProducts[i].IS_HasMODIFIER + '</td><td style="display:none;">' + lstProducts[i].DeliveryType + '</td><td style="display:none;">' + lstProducts[i].SALE_INVOICE_DETAIL_ID + '</td><td style="display:none;">' + lstProducts[i].IS_FREE + '</td><td style="display:none;">' + lstProducts[i].QTY + '</td><td style="display:none;">' + lstProducts[i].PRINT_QTY + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + lstProducts[i].GSTPER + '</td><td style="display:none;">' + gstamount + '</td><td style="display:none;">' + discount + '</td><td style="display:none;">' + lstProducts[i].TIME_STAMP3 + '</td></tr>');
                }
            }
            else {
...
function addProductToOrderedProduct2(lstProducts, i, invoiceId) {
    ...
    if (lstProducts[i].T_PRICE.toString().indexOf(".") == -1) {
        ...
        amount = lstProducts[i].AMOUNT;
        amount2 = parseFloat($('#txtQuantity').val()) * parseFloat(tprice) - parseFloat(discount2);
    }
    else {
        tprice = parseFloat($('#txtSKUPrice').val()).toFixed(2);
        amount = parseFloat(lstProducts[i].AMOUNT).toFixed(2);
    ...
    if (lstProducts[i].DIV_ID == "2") {//WHEN DIVISION IS VALUE BASE FOR ALIALFAZAL
        ...
        if (lstProducts[i].I_D_ID == "0") {//WHEN DEALS IS OFF 
            if (lstProducts[i].MODIFIER == "0") {//CHECK IS MODIFIER OR NOT IF NOT THEN
                row = $('<tr><td style="display:none;">' + lstProducts[i].SKU_ID + '</td><td>' + lstProducts[i].strERPCode + '</td><td class="table-text2">' + lstProducts[i].SKU_NAME + '<span style="color:red"> - ' + time + '</span></td><td align="center" onclick="plusQty(this);"><span style="margin-right: 5px; cursor: pointer;"><img src="../images/plus.png"></span></td> <td align="center"><input type="text" size="2" value="' + $('#txtQuantity').val() + '"  style="text-align: center;" onkeyup="QtyChanged(this);" onblur="CheckQty(this);"></td><td align="center" onclick="decreaseItem(this);"><span style="margin-left: 5px; cursor: pointer;"><img src="../images/minus.png"></span></td><td class="table-text2">' + tprice + '</td><td class="table-text2">' + amount2 + '</td><td align="center" onclick="deleteItem(this);"><a href="#"><span class="fa fa-times"></span></a></td><td style="display:none;">' + lstProducts[i].PRINTER + '</td><td style="display:none;">' + lstProducts[i].PR_COUNT + '</td><td style="display:none;">' + lstProducts[i].SEC_ID + '</td><td style="display:none;">' + lstProducts[i].SECTION + '</td><td style="display:none;">' + lstProducts[i].C1 + '</td><td style="display:none;">' + lstProducts[i].VOID + '</td><td style="display:none;">' + lstProducts[i].CAT_ID + '</td><td style="display:none;">' + invoiceId + '</td><td style="display:none;">' + lstProducts[i].IS_DESC + '</td><td style="display:none;">' + lstProducts[i].DESC + '</td><td style="display:none;">' + lstProducts[i].PRINT + '</td><td style="display:none;">' + lstProducts[i].DIV_ID + '</td><td style="display:none;">' + lstProducts[i].A_PRICE + '</td><td style="display:none;">' + lstProducts[i].I_D_ID + '</td><td style="display:none;">' + lstProducts[i].C2 + '</td><td style="display:none;">' + lstProducts[i].H + '</td><td style="display:none;">' + lstProducts[i].intDealID + '</td><td style="display:none;">' + lstProducts[i].lngDealDetailID + '</td><td style="display:none;">' + lstProducts[i].DEAL_QTY + '</td><td style="display:none;">' + lstProducts[i].Cat_Quantity + '</td><td style="display:none;">' + lstProducts[i].Is_CatChoice + '</td><td style="display:none;">' + lstProducts[i].Is_ItemChoice + '</td><td style="display:none;">' + lstProducts[i].Is_Optional + '</td><td style="display:none;">' + lstProducts[i].DEAL_NAME + '</td><td style="display:none;">' + lstProducts[i].UOM_ID + '</td><td style="display:none;">' + lstProducts[i].intStockMUnitCode + '</td><td style="display:none;">' + lstProducts[i].Stock_to_SaleOperator + '</td><td style="display:none;">' + lstProducts[i].Stock_to_SaleFactor + '</td><td style="display:none;">' + lstProducts[i].DEFAULT_QTY + '</td><td style="display:none;">' + lstProducts[i].IS_HasMODIFIER + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + lstProducts[i].SortOrder + '</td><td style="display:none;">' + lstProducts[i].GSTPER + '</td><td style="display:none;">' + gstamount + '</td><td style="display:none;">' + discount2 + '</td><td style="display:none;">' + now + '</td></tr>');
            }
            else {
                if (lstProducts[i].T_PRICE == "0") {
                    row = $('<tr><td style="display:none;">' + lstProducts[i].SKU_ID + '</td><td>' + lstProducts[i].strERPCode + '</td><td class="table-text2" style="color: red" colspan="6">' + lstProducts[i].SKU_NAME + '<span style="color:red"> - ' + time + '</span></td><td style="display:none;" onclick="plusQty(this);"><span style="margin-right: 5px; cursor: pointer;"><img src="../images/plus.png"></span></td> <td style="display:none;"><input type="text" size="2" value="' + 1 + '"  style="text-align: center;" onkeyup="QtyChanged(this);" onblur="CheckQty(this);"></td><td style="display:none;" onclick="decreaseItem(this);"><span style="margin-left: 5px; cursor: pointer;"><img src="../images/minus.png"></span></td><td style="display:none;" class="table-text2">' + tprice + '</td><td style="display:none;" class="table-text2">' + amount2 + '</td><td align="center" onclick="deleteItem(this);"><a href="#"><span class="fa fa-times"></span></a></td><td style="display:none;">' + lstProducts[i].PRINTER + '</td><td style="display:none;">' + lstProducts[i].PR_COUNT + '</td><td style="display:none;">' + lstProducts[i].SEC_ID + '</td><td style="display:none;">' + lstProducts[i].SECTION + '</td><td style="display:none;">' + lstProducts[i].C1 + '</td><td style="display:none;">' + lstProducts[i].VOID + '</td><td style="display:none;">' + lstProducts[i].CAT_ID + '</td><td style="display:none;">' + invoiceId + '</td><td style="display:none;">' + lstProducts[i].IS_DESC + '</td><td style="display:none;">' + lstProducts[i].DESC + '</td><td style="display:none;">' + lstProducts[i].PRINT + '</td><td style="display:none;">' + lstProducts[i].DIV_ID + '</td><td style="display:none;">' + lstProducts[i].A_PRICE + '</td><td style="display:none;">' + lstProducts[i].I_D_ID + '</td><td style="display:none;">' + lstProducts[i].C2 + '</td><td style="display:none;">' + lstProducts[i].H + '</td><td style="display:none;">' + lstProducts[i].intDealID + '</td><td style="display:none;">' + lstProducts[i].lngDealDetailID + '</td><td style="display:none;">' + lstProducts[i].DEAL_QTY + '</td><td style="display:none;">' + lstProducts[i].Cat_Quantity + '</td><td style="display:none;">' + lstProducts[i].Is_CatChoice + '</td><td style="display:none;">' + lstProducts[i].Is_ItemChoice + '</td><td style="display:none;">' + lstProducts[i].Is_Optional + '</td><td style="display:none;">' + lstProducts[i].DEAL_NAME + '</td><td style="display:none;">' + lstProducts[i].UOM_ID + '</td><td style="display:none;">' + lstProducts[i].intStockMUnitCode + '</td><td style="display:none;">' + lstProducts[i].Stock_to_SaleOperator + '</td><td style="display:none;">' + lstProducts[i].Stock_to_SaleFactor + '</td><td style="display:none;">' + lstProducts[i].DEFAULT_QTY + '</td><td style="display:none;">' + lstProducts[i].IS_HasMODIFIER + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + lstProducts[i].SortOrder + '</td><td style="display:none;">' + lstProducts[i].GSTPER + '</td><td style="display:none;">' + gstamount + '</td><td style="display:none;">' + discount2 + '</td><td style="display:none;">' + now + '</td></tr>');
                }
                else {
            ...
            if (lstProducts[i].MODIFIER == "1") {
                if (lstProducts[i].T_PRICE == "0") {
                    row = $('<tr><td style="display:none;">' + lstProducts[i].SKU_ID + '</td><td>' + lstProducts[i].strERPCode + '</td><td class="table-text2" style="color: red">' + lstProducts[i].SKU_NAME + '<span style="color:red"> - ' + time + '</span></td><td style="display: none;" onclick="plusQty(this);"><span style="margin-right: 5px; cursor: pointer;"><img src="../images/plus.png"></span></td> <td align="center"><input type="text" size="2" value="' + 1 + '"  style="text-align: center;" onkeyup="QtyChanged(this);" onblur="CheckQty(this);"></td><td style="display: none;" onclick="decreaseItem(this);"><span style="margin-left: 5px; cursor: pointer;"><img src="../images/minus.png"></span></td><td class="table-text2">' + 0 + '</td><td class="table-text2">' + amount2 + '</td><td style="display: none;" onclick="deleteItem(this);"><a href="#"><span class="fa fa-times"></span></a></td><td style="display:none;">' + lstProducts[i].PRINTER + '</td><td style="display:none;">' + lstProducts[i].PR_COUNT + '</td><td style="display:none;">' + lstProducts[i].SEC_ID + '</td><td style="display:none;">' + lstProducts[i].SECTION + '</td><td style="display:none;">' + lstProducts[i].C1 + '</td><td style="display:none;">' + lstProducts[i].VOID + '</td><td style="display:none;">' + lstProducts[i].CAT_ID + '</td><td style="display:none;">' + invoiceId + '</td><td style="display:none;">' + lstProducts[i].IS_DESC + '</td><td style="display:none;">' + lstProducts[i].DESC + '</td><td style="display:none;">' + lstProducts[i].PRINT + '</td><td style="display:none;">' + lstProducts[i].DIV_ID + '</td><td style="display:none;">' + lstProducts[i].A_PRICE + '</td><td style="display:none;">' + lstProducts[i].I_D_ID + '</td><td style="display:none;">' + lstProducts[i].C2 + '</td><td style="display:none;">' + lstProducts[i].H + '</td><td style="display:none;">' + lstProducts[i].intDealID + '</td><td style="display:none;">' + lstProducts[i].lngDealDetailID + '</td><td style="display:none;">' + lstProducts[i].DEAL_QTY + '</td><td style="display:none;">' + lstProducts[i].Cat_Quantity + '</td><td style="display:none;">' + lstProducts[i].Is_CatChoice + '</td><td style="display:none;">' + lstProducts[i].Is_ItemChoice + '</td><td style="display:none;">' + lstProducts[i].Is_Optional + '</td><td style="display:none;">' + lstProducts[i].DEAL_NAME + '</td><td style="display:none;">' + lstProducts[i].UOM_ID + '</td><td style="display:none;">' + lstProducts[i].intStockMUnitCode + '</td><td style="display:none;">' + lstProducts[i].Stock_to_SaleOperator + '</td><td style="display:none;">' + lstProducts[i].Stock_to_SaleFactor + '</td><td style="display:none;">' + lstProducts[i].DEFAULT_QTY + '</td><td style="display:none;">' + lstProducts[i].IS_HasMODIFIER + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + lstProducts[i].SortOrder + '</td><td style="display:none;">' + lstProducts[i].GSTPER + '</td><td style="display:none;">' + gstamount + '</td><td style="display:none;">' + discount2 + '</td><td style="display:none;">' + now + '</td></tr>');
                }
                else {
                    row = $('<tr><td style="display:none;">' + lstProducts[i].SKU_ID + '</td><td>' + lstProducts[i].strERPCode + '</td><td style="color: red" class="table-text2">' + lstProducts[i].SKU_NAME + '<span style="color:red"> - ' + time + '</span></td><td align="center" onclick="plusQty(this);"><span style="margin-right: 5px; cursor: pointer;"><img src="../images/plus.png"></span></td> <td align="center"><input type="text" size="2" value="' + $('#txtQuantity').val() + '"  style="text-align: center;" onkeyup="QtyChanged(this);" onblur="CheckQty(this);"></td><td align="center" onclick="decreaseItem(this);"><span style="margin-left: 5px; cursor: pointer;"><img src="../images/minus.png"></span></td><td class="table-text2">' + 0 + '</td><td class="table-text2">' + amount2 + '</td><td align="center" onclick="deleteItem(this);"><a href="#"><span class="fa fa-times"></span></a></td><td style="display:none;">' + lstProducts[i].PRINTER + '</td><td style="display:none;">' + lstProducts[i].PR_COUNT + '</td><td style="display:none;">' + lstProducts[i].SEC_ID + '</td><td style="display:none;">' + lstProducts[i].SECTION + '</td><td style="display:none;">' + lstProducts[i].C1 + '</td><td style="display:none;">' + lstProducts[i].VOID + '</td><td style="display:none;">' + lstProducts[i].CAT_ID + '</td><td style="display:none;">' + invoiceId + '</td><td style="display:none;">' + lstProducts[i].IS_DESC + '</td><td style="display:none;">' + lstProducts[i].DESC + '</td><td style="display:none;">' + lstProducts[i].PRINT + '</td><td style="display:none;">' + lstProducts[i].DIV_ID + '</td><td style="display:none;">' + lstProducts[i].A_PRICE + '</td><td style="display:none;">' + lstProducts[i].I_D_ID + '</td><td style="display:none;">' + lstProducts[i].C2 + '</td><td style="display:none;">' + lstProducts[i].H + '</td><td style="display:none;">' + lstProducts[i].intDealID + '</td><td style="display:none;">' + lstProducts[i].lngDealDetailID + '</td><td style="display:none;">' + lstProducts[i].DEAL_QTY + '</td><td style="display:none;">' + lstProducts[i].Cat_Quantity + '</td><td style="display:none;">' + lstProducts[i].Is_CatChoice + '</td><td style="display:none;">' + lstProducts[i].Is_ItemChoice + '</td><td style="display:none;">' + lstProducts[i].Is_Optional + '</td><td style="display:none;">' + lstProducts[i].DEAL_NAME + '</td><td style="display:none;">' + lstProducts[i].UOM_ID + '</td><td style="display:none;">' + lstProducts[i].intStockMUnitCode + '</td><td style="display:none;">' + lstProducts[i].Stock_to_SaleOperator + '</td><td style="display:none;">' + lstProducts[i].Stock_to_SaleFactor + '</td><td style="display:none;">' + lstProducts[i].DEFAULT_QTY + '</td><td style="display:none;">' + lstProducts[i].IS_HasMODIFIER + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + 0 + '</td><td style="display:none;">' + lstProducts[i].SortOrder + '</td><td style="display:none;">' + lstProducts[i].GSTPER + '</td><td style="display:none;">' + gstamount + '</td><td style="display:none;">' + discount2 + '</td><td style="display:none;">' + now + '</td></tr>');
                }
            }
            else {
                if (lstProducts[i].Is_ItemChoice == "1") {//WHEN DEALS IS ON AND IS_DEFAULT SET TO TRUE  
...
function startWeightRead() {
    if (weightTimer !== null) return;

    weightTimer = setInterval(function () {
