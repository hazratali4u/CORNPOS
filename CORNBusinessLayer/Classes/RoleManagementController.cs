...
namespace CORNBusinessLayer.Classes
{
    ...
    public class RoleManagementController
    {
        ...
        public DataTable GetAccountHeadModule(int p_MODULE_ID,int p_ACCOUNT_PARENT_ID,int p_ACCOUNT_CATEGORY_ID, int p_TYPE)
        {
            IDbConnection mConnection = null;
            try
            {
                ...
                uspGetAccountHeadModule ObjSelect = new uspGetAccountHeadModule();
                ObjSelect.Connection = mConnection;
                ObjSelect.MODULE_ID = p_MODULE_ID;
        ...
        public DataTable SelectRoleWiseModule(int p_RoleId, int p_UserId)
        {
            IDbConnection mConnection = null;
            try
            {
                mConnection = ProviderFactory.GetConnection(Configuration.ConnectionString, EnumProviders.SQLClient);
                mConnection.Open();
                GetAssingUserModule2 ObjSelect = new GetAssingUserModule2();
                ObjSelect.Connection = mConnection;
                ObjSelect.ROLE_ID = p_RoleId;
        ...
        public bool InsertAccountHeadModule(int p_MODULE_ID, int p_ACCOUNT_HEAD_ID, int p_USER_ID,int p_TYPE_ID)
        {
            IDbConnection mConnection = null;
            try
            {
                mConnection = ProviderFactory.GetConnection(Configuration.ConnectionString, EnumProviders.SQLClient);
                mConnection.Open();
                uspInsertACCOUNT_HEAD_MODULE ObjInsert = new uspInsertACCOUNT_HEAD_MODULE();
                ObjInsert.Connection = mConnection;
                ObjInsert.MODULE_ID = p_MODULE_ID;
                ObjInsert.ACCOUNT_HEAD_ID = p_ACCOUNT_HEAD_ID;
