...
{
    public class spSelectCHEQUE_PROCESS2
    {
        ...
        #region Constructor
        public spSelectCHEQUE_PROCESS2()
        {
            ...
            m_CHEQUE_NO = null;
            m_BANK_NAME = null;
            m_CHEQUE_PROCESS_ID = Constants.LongNullValue;
        }
        #endregion
        ...
        public DataTable ExecuteTable()
        {
            try
            {
                ...
                command.CommandText = "spSelectCHEQUE_PROCESS2";
