...
{
    public class spInsertFranchiseSaleInvoice_Master
    {
        #region Private Members
        private string sp_Name = "spInsertFRANCHISE_SALE_INVOICE_MASTER";
        ...
        #endregion
        #region Constructor
        public spInsertFranchiseSaleInvoice_Master()
        {
            REMARKS = "";
