...
{
	public class spSelectPurchaseOrderDetail
    {
		...
		#region Constructor
		public spSelectPurchaseOrderDetail()
		{
		...
		public DataTable ExecuteTable()
		{
			try
			{
				...
				command.CommandText = "spSelectPurchaseOrderDetail";
        ...
        public DataTable ExecuteTableForPurchaseOrder_Update()
        {
            try
            {
                IDbCommand command = ProviderFactory.GetCommand(EnumProviders.SQLClient);
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = "spSelectPurchaseOrderDetailForUpdate";
                command.Connection = m_connection;
                if (m_transaction != null)
                {
                    command.Transaction = m_transaction;
