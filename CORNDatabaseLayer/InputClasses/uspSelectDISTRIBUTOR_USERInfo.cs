...
{
    public class uspSelectDISTRIBUTOR_USERInfo
    {
        ...
        #region Constructor
        public uspSelectDISTRIBUTOR_USERInfo()
        {
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "uspSelectDISTRIBUTOR_USERInfo";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "uspSelectDISTRIBUTOR_USERInfo";
