...
{
    public class spInsertSALE_INVOICE_DETAIL3
    {
        #region Private Members
        private string sp_Name = "spInsertSALE_INVOICE_DETAIL3";
        ...
        #endregion
        #region Constructor
        public spInsertSALE_INVOICE_DETAIL3()
        {
        ...
        public bool ExecuteQueryForKDSAsVOID()
        {
            try
            {
                IDbCommand cmd = ProviderFactory.GetCommand(EnumProviders.SQLClient);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "spUpdateKDSASVOID";
                cmd.Connection = m_connection;
                if (m_transaction != null)
                {
                    cmd.Transaction = m_transaction;
                }
                GetParameterCollectionForKDSAsVOID(ref cmd);
                cmd.ExecuteNonQuery();
                return true;
            }
            catch (Exception e)
        ...
        public bool ExecuteQueryForKDSUpdate()
        {
            try
            {
                IDbCommand cmd = ProviderFactory.GetCommand(EnumProviders.SQLClient);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "spUpdateKDS_History";
                cmd.Connection = m_connection;
                if (m_transaction != null)
                {
                    cmd.Transaction = m_transaction;
                }
                GetParameterCollectionForKDSUpdate(ref cmd);
                cmd.ExecuteNonQuery();
                return true;
            }
            catch (Exception e)
        ...
        public void GetParameterCollectionForKDSAsVOID(ref IDbCommand cmd)
        {
            IDataParameterCollection pparams = cmd.Parameters;
            IDataParameter parameter;
        ...
        public void GetParameterCollectionForKDSUpdate(ref IDbCommand cmd)
        {
            IDataParameterCollection pparams = cmd.Parameters;
            IDataParameter parameter;
