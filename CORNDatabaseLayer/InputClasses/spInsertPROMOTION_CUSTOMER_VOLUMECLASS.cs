...
{
    public class spInsertPROMOTION_CUSTOMER_VOLUMECLASS
    {
        ...
        #region Constructor
        public spInsertPROMOTION_CUSTOMER_VOLUMECLASS()
        {
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "spInsertPROMOTION_CUSTOMER_VOLUMECLASS";
                ...
                cmd.ExecuteNonQuery();
                m_PROMOTION_VOLUMECLASS_ID = (long)((IDataParameter)(cmd.Parameters["@PROMOTION_VOLUMECLASS_ID"])).Value;
                return true;
            }
            catch (Exception e)
            {
