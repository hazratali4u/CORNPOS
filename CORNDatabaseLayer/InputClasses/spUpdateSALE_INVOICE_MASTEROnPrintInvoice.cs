...
{
    public class spUpdateSALE_INVOICE_MASTEROnPrintInvoice
    {
        #region Private Members
        private string sp_Name = "spUpdateSALE_INVOICE_MASTEROnPrintInvoice";
        ...
        #endregion
        #region Constructor
        public spUpdateSALE_INVOICE_MASTEROnPrintInvoice()
        {
