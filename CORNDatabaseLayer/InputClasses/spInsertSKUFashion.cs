...
{
	public class spInsertSKUFashion
	{
		#region Private Members
		private string sp_Name = " spInsertSKUFashion";
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spInsertSKUFashion";
				...
				cmd.ExecuteNonQuery();
				SKU_ID = (int)((IDataParameter)(cmd.Parameters["@SKU_ID"])).Value;
				return true;
			}
			catch(Exception e)
			{
