...
{
    public class spInsertPROMOTION_CUSTOMER_TYPE
    {
        ...
        #region Constructor
        public spInsertPROMOTION_CUSTOMER_TYPE()
        {
            m_PROMOTION_ID = Constants.LongNullValue;
            m_PROMOTION_CUSTOMER_TYPE_ID = Constants.LongNullValue;
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "spInsertPROMOTION_CUSTOMER_TYPE";
                ...
                cmd.ExecuteNonQuery();
                m_PROMOTION_CUSTOMER_TYPE_ID = (long)((IDataParameter)(cmd.Parameters["@PROMOTION_CUSTOMER_TYPE_ID"])).Value;
                return true;
            }
            catch (Exception e)
            {
