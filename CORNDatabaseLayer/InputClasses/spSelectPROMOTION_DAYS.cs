...
{
    public class spSelectPROMOTION_DAYS
    {
        ...
        public DataTable ExecuteTable()
        {
            try
            {
                ...
                command.CommandText = "spSelectPROMOTION_DAYS";
        ...
        public void GetParameterCollection(ref IDbCommand cmd)
        {
            ...
            if (m_PROMOTION_DAYS_ID == Constants.LongNullValue)
            {
                parameter.Value = DBNull.Value;
            }
            else
            {
                parameter.Value = m_PROMOTION_DAYS_ID;
            }
