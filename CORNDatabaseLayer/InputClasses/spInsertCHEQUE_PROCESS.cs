...
namespace CORNDatabaseLayer.Classes
{
    public class spInsertCHEQUE_PROCESS
    {
        ...
        private int m_chequeType;
        private Int16 m_DISCOUNT_TYPE;
        private int m_TAX_ACCOUNT_ID;
        private decimal m_WithHeldSalesTaxAmount;
        private bool m_IsAdvance;
        #endregion
        ...
        {
            set { m_IsAdvance = value; }
            get { return m_IsAdvance; }
        }
        ...
        public void GetParameterCollection(ref IDbCommand cmd)
        {
            ...
            parameter.ParameterName = "@chequeType";
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.Int);
            if (m_chequeType == Constants.IntNullValue)
            {
                parameter.Value = DBNull.Value;
            }
            else
            {
                parameter.Value = m_chequeType;
            }
            ...
            parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
            parameter.ParameterName = "@IsAdvance";
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.Bit);
            parameter.Value = m_IsAdvance;
            pparams.Add(parameter);
