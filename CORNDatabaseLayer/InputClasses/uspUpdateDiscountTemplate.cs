...
{
    public class uspUpdateDiscountTemplate
    {
        #region Private Members
        private string sp_Name = "uspUpdateDiscountTemplate";
        ...
        public int EmployeeDiscountTypeID
        {
            set
            {
                m_EmployeeDiscountTypeID = value;
            }
            get
            {
                return m_EmployeeDiscountTypeID;
            }
        }
        public int UserID
        {
        ...
        #endregion
        #region Constructor
        public uspUpdateDiscountTemplate()
        {
        }
        #endregion
