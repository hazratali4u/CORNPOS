...
{
	public class uspSelectPrincipalAreaWiseSaleForce
	{
		#region Private Members
		private string sp_Name = "uspSelectPrincipalAreaWiseSaleForce" ;
		...
		#endregion
		#region Constructor
		public uspSelectPrincipalAreaWiseSaleForce()
		{
		}
		#endregion
        ...
        public DataSet ExecuteTableSet()
        {
            try
            {
                IDbCommand command = ProviderFactory.GetCommand(EnumProviders.SQLClient);
