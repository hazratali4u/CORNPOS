...
namespace CORNDatabaseLayer.Classes
{
    public class spSelectPRINCIPAL
    {
        ...
        public DataTable ExecuteTablePCategory()
        {
            try
            {
                IDbCommand command = ProviderFactory.GetCommand(EnumProviders.SQLClient);
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = "spSelectPRINCIPALFashion";
                command.Connection = m_connection;
                if (m_transaction != null)
                {
                    command.Transaction = m_transaction;
                }
                GetParameterParentCategoryCollection(ref command);
        ...
        public void GetParameterParentCategoryCollection(ref IDbCommand cmd)
        {
            IDataParameterCollection pparams = cmd.Parameters;
            IDataParameter parameter;
