...
{
	public class uspInsertLoyaltyCardSalab
	{
		#region Private Members
		private string sp_Name = "uspInsertLoyaltyCardSalab" ;
		...
		private DateTime m_dtmDocumentDate;
		...
		public DateTime dtmDocumentDate
		{
			set
			{
				m_dtmDocumentDate = value ;
			}
			get
			{
				return m_dtmDocumentDate;
			}
		}
        ...
        {
            get { return m_lngLoyaltyCardSalabID; }
        }
		...
		#endregion
		#region Constructor
		public uspInsertLoyaltyCardSalab()
		{
		}
		#endregion
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.ExecuteNonQuery();
                m_lngLoyaltyCardSalabID= (long)((IDataParameter)(cmd.Parameters["@lngLoyaltyCardSalabID"])).Value;
                return true;
			}
			catch(Exception e)
			{
		...
		public void GetParameterCollection(ref IDbCommand cmd)
		{
			...
			parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
			parameter.ParameterName = "@dtmDocumentDate" ; 
			parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.DateTime);
			if(m_dtmDocumentDate==Constants.DateNullValue)
			{
				parameter.Value = DBNull.Value;
			}
			else
			{
				parameter.Value = m_dtmDocumentDate;
			}
			pparams.Add(parameter);
