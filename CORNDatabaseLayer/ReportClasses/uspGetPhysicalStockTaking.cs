...
{
    public class uspGetPhysicalStockTaking
    {
        #region Private Members
        private string sp_Name = "uspGetPhysicalStockTaking";
        ...
        #endregion
        #region Constructor
        public uspGetPhysicalStockTaking()
        {
        }
        #endregion
        ...
        public DataTable ExecuteTableForPurchaseMasterByStockTakingID()
        {
            try
            {
                IDbCommand command = ProviderFactory.GetCommand(EnumProviders.SQLClient);
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = "spSelectPurchaseMasterIDByStockTakingID";
                command.Connection = m_connection;
                if (m_transaction != null)
                {
                    command.Transaction = m_transaction;
                }
                GetParameterCollectionForPurchaseMasterIDByStockTakingID(ref command);
                IDbDataAdapter da = ProviderFactory.GetAdapter(EnumProviders.SQLClient);
                da.SelectCommand = command;
                DataSet ds = new DataSet();
                da.Fill(ds);
        ...
        public void GetParameterCollectionForPurchaseMasterIDByStockTakingID(ref IDbCommand cmd)
        {
            IDataParameterCollection pparams = cmd.Parameters;
            IDataParameter parameter;
            parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
