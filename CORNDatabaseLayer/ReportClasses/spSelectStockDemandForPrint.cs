...
{
	public class spSelectStockDemandForPrint
	{
		#region Private Members
		private string sp_Name = "spSelectStockDemandForPrint" ;
		...
		#endregion
		#region Constructor
		public spSelectStockDemandForPrint()
		{
            m_STOCK_DEMAND_ID = Constants.IntNullValue;
